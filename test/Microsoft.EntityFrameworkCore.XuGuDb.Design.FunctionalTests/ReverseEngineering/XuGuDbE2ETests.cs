...
namespace Microsoft.EntityFrameworkCore.XuGuDb.Design.FunctionalTests.ReverseEngineering
{
    ...
    public class XuGuDbE2ETests : E2ETestBase, IClassFixture<XuGuDbE2EFixture>
    {
        protected override string ProviderName => "Microsoft.EntityFrameworkCore.XuGuDb.Design";

        protected override IServiceCollection ConfigureDesignTimeServices(IServiceCollection services)
            => new XuGuDbDesignTimeServices().ConfigureDesignTimeServices(services);
        ...
        public XuGuDbE2ETests(XuGuDbE2EFixture fixture, ITestOutputHelper output)
            : base(output)
        {
        }
        ...
        private readonly string _connectionString =
            ...
            {
                InitialCatalog = "XuGuDbReverseEngineerTestE2E"
            }.ConnectionString;
        ...
        public void E2ETest_UseAttributesInsteadOfFluentApi()
        {
            ...
            AssertLog(new LoggerMessages
            {
                Warn =
                {
                    ...
                    XuGuDbDesignStrings.DataTypeDoesNotAllowXuGuDbIdentityStrategy("dbo.PropertyConfiguration.PropertyConfigurationID", "tinyint"),
        ...
        public void E2ETest_AllFluentApi()
        {
            ...
            {
                Files = new List<string> { "XuGuDbReverseEngineerTestE2EContext.expected" }
                    .Concat(_expectedEntityTypeFiles).ToList()
            };
        ...
        {
            using (var scratch = XuGuDbTestStore.CreateScratch())
            {
...
CREATE SEQUENCE NumericSequence
    AS numeric;");
        ...
        protected override ICollection<BuildReference> References { get; } = new List<BuildReference>
        {
            ...
            BuildReference.ByName("Microsoft.EntityFrameworkCore.XuGuDb", depContextAssembly: typeof(XuGuDbE2ETests).GetTypeInfo().Assembly),
#else
            ...
            BuildReference.ByName("Microsoft.EntityFrameworkCore.XuGuDb"),
#endif
