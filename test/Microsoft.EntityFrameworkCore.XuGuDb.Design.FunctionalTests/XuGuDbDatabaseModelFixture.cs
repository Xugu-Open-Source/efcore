...
{
    public class XuGuDbDatabaseModelFixture : IDisposable
    {
        public XuGuDbDatabaseModelFixture()
        {
            TestStore = XuGuDbTestStore.CreateScratch();
        }
        ...
        public DatabaseModel CreateModel(string createSql, TableSelectionSet selection = null, ILogger logger = null)
        {
            ...
            return new XuGuDbDatabaseModelFactory(new TestLoggerFactory(logger))
                .Create(TestStore.ConnectionString, selection ?? TableSelectionSet.All);
        }

        public XuGuDbTestStore TestStore { get; }
