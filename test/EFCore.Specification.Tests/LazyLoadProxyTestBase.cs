    ...
    where TFixture : LazyLoadProxyTestBase<TFixture>.LoadFixtureBase
{
  ...
  ""$values"": [
    ...
    public abstract class LoadFixtureBase : SharedStoreFixtureBase<DbContext>
    {
        ...
        {
            modelBuilder.Entity<Tribe>();//.Property(i=>i.Id).ValueGeneratedOnAdd();
            modelBuilder.Entity<Called>();//.Property(i=>i.Id).ValueGeneratedOnAdd();
            modelBuilder.Entity<Quest>();//.Property(i=>i.Id).ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<ExplicitLazyLoadNonVirtualOneToManyOwner>()
                .OwnsMany(o => o.Addresses, a => a.HasKey("Id"));
            modelBuilder.Entity<ExplicitLazyLoadNonVirtualOneToManyOwner>().Property(i=>i.Id).ValueGeneratedOnAdd();
            modelBuilder.Entity<ExplicitLazyLoadVirtualOneToManyOwner>()
                .OwnsMany(o => o.Addresses, a => a.HasKey("Id"));
            modelBuilder.Entity<ExplicitLazyLoadVirtualOneToManyOwner>().Property(i=>i.Id).ValueGeneratedOnAdd();
        }
