...
{
    [SupportedServerVersionCondition(nameof(ServerVersionSupport.XGBug96947Workaround))]
...
ORDER BY `od1`.`OrderID`;";
        ...
        {
            // Parameters are an issue as well, because the get inlined by XGConnector and
