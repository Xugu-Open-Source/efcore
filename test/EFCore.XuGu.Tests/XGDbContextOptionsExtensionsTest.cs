...
namespace Microsoft.EntityFrameworkCore.XuGu
{
    public class XGDbContextOptionsBuilderExtensionsTest
    {
        ...
        public void UseXG_with_XGServerVersion_Version()
        {
            ...
            Assert.Equal("xugu", xgOptions.ServerVersion.TypeIdentifier);
        }
        ...
        public void UseXG_with_XGServerVersion_string_version_full()
        {
            ...
            builder.UseXG(
                "Server=foo",
                new XGServerVersion("8.0.21-xugu"));
        ...
        {
            var builder = new DbContextOptionsBuilder();
            var serverVersion = ServerVersion.Parse("8.0.21-xugu");
        ...
        [InlineData(false)]
        [InlineData(true)]
        public async Task UseXG_with_ServerVersion_AutoDetect_connection_string(bool async)
        {
            var builder = new DbContextOptionsBuilder();
        ...
        [InlineData(false)]
        [InlineData(true)]
        public async Task UseXG_with_ServerVersion_AutoDetect_connection_closed(bool async)
        {
            var builder = new DbContextOptionsBuilder();
            await using var connection = new XGConnection(AppConfig.ConnectionString);
            var serverVersion = async
        ...
        [InlineData(false)]
        [InlineData(true)]
        public async Task UseXG_with_ServerVersion_AutoDetect_connection_opened(bool async)
        {
            var builder = new DbContextOptionsBuilder();
        ...
        //[InlineData(false)]
        //[InlineData(true)]
        //public async Task UseXG_with_ServerVersion_AutoDetect_datasource(bool async)
        //{
        //    var builder = new DbContextOptionsBuilder();
        //    await using var dataSource = new XGDataSource(AppConfig.ConnectionString);
        //    var serverVersion = async
        ...
        {
            var builder = new DbContextOptionsBuilder();
            var serverVersion = XGServerVersion.LatestSupportedServerVersion;
