...
builder.Entity(""Microsoft.EntityFrameworkCore.XuGu.Migrations.ModelSnapshotXGTest+DataTypesVariable"", b =>
    {
        b.Property<int>(""Id"")
            .ValueGeneratedOnAdd();
...
",
        ...
        protected virtual ICollection<BuildReference> GetReferences() => new List<BuildReference>
        {
            ...
            BuildReference.ByName("Microsoft.EntityFrameworkCore.XuGu")
        };
