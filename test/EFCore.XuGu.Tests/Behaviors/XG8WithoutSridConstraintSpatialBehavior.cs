...
namespace Microsoft.EntityFrameworkCore.XuGu.Behaviors
{
    ...
    public class XG8WithoutSridConstraintSpatialBehavior : RawSqlTestWithFixture<XG8WithoutSridConstraintSpatialBehavior.XG8WithoutSridConstraintSpatialBehaviorFixture>
    {
        public XG8WithoutSridConstraintSpatialBehavior(XG8WithoutSridConstraintSpatialBehaviorFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        }
        ...
        [Fact]
        public void XG8_longitude_latitude_order_depends_on_srid()
        {
...
FROM `IceCreamShops`;";
            ...
            while (dataReader.Read())
            {
                ...
                if (srid == 4326)
                {
                    // X and Y coordinates should be swapped in the database in comparison to NTS, because XuGu expects X to be latitude
        ...
        public class XG8WithoutSridConstraintSpatialBehaviorFixture : XGTestFixtureBase<Model.SpatialBehaviorContext>
        {
