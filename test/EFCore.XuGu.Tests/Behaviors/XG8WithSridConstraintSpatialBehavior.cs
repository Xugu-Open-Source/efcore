...
namespace Microsoft.EntityFrameworkCore.XuGu.Behaviors
{
    ...
    public class XG8WithSridConstraintSpatialBehavior : RawSqlTestWithFixture<XG8WithSridConstraintSpatialBehavior.XG8WithSridConstraintSpatialBehaviorFixture>
    {
        public XG8WithSridConstraintSpatialBehavior(XG8WithSridConstraintSpatialBehaviorFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        }
        ...
        [Fact]
        public void XG8_uses_x_latitude_and_y_longitude_order_for_srid_4326()
        {
...
FROM `IceCreamShops`;";
        ...
        public class XG8WithSridConstraintSpatialBehaviorFixture : XGTestFixtureBase<Model.SpatialBehaviorContext>
        {
