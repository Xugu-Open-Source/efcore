...
namespace Microsoft.EntityFrameworkCore.XuGu.Behaviors
{
    ...
    public class SpatialBehavior : RawSqlTestWithFixture<SpatialBehavior.SpatialBehaviorFixture>
    {
        ...
        [Fact]
        public void XG7_and_XuGu_use_x_longitude_and_y_latitude_order()
        {
...
FROM `IceCreamShops`;";
            ...
            while (dataReader.Read())
            {
                ...
                // X and Y coordinates should be in the same order in the database that they are used in NTS, because XG < 12
            ...
            public class SpatialBehaviorContext : ContextBase
            {
                ...
                protected override void OnModelCreating(ModelBuilder modelBuilder)
                {
                    ...
                    modelBuilder.Entity<IceCreamShop>(
                        entity =>
                        {
                            // This has no effect on XG < 12, because XG < 12 do not support SRID constraints.
                            //
