...
{
    public sealed class XGCollationTest : TestWithFixture<XGCollationTest.XGCollationFixture>
    {
        public XGCollationTest(XGCollationFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            public class XGCollationContext : ContextBase
            {
