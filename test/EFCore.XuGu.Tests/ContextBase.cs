...
namespace Microsoft.EntityFrameworkCore.XuGu
{
    public class ContextBase : DbContext
    {
        ...
        private Action<XGDbContextOptionsBuilder> _xgOptions;
        ...
        {
            _serviceProvider = (serviceCollection ?? new ServiceCollection().AddEntityFrameworkXG())
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (_model != null)
            {
                var conventionSet = XGConventionSetBuilder.Build();
