...
{
    public class XuGuDbValueGeneratorCacheTest
    {
        [Fact]
        public void Uses_single_generator_per_property()
        {
            ...
            var cache = XuGuDbTestHelpers.Instance.CreateContextServices(model).GetRequiredService<IXuGuDbValueGeneratorCache>();
        ...
        public void Block_size_is_obtained_from_default_sequence()
        {
            ...
            var cache = new XuGuDbValueGeneratorCache();
        ...
        public void Block_size_is_obtained_from_named_sequence()
        {
            var property = CreateConventionModelBuilder()
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForXuGuDbUseSequenceHiLo("DaneelOlivaw")
                .Metadata;
        ...
        {
            var property = CreateConventionModelBuilder()
                .ForXuGuDbHasSequence("DaneelOlivaw", b => b.IncrementsBy(11))
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForXuGuDbUseSequenceHiLo("DaneelOlivaw")
                .Metadata;
        ...
        {
            var property = CreateConventionModelBuilder()
                .ForXuGuDbHasSequence("DaneelOlivaw", b => b.IncrementsBy(-1))
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForXuGuDbUseSequenceHiLo("DaneelOlivaw")
                .Metadata;
        ...
        public void Schema_qualified_sequence_name_is_obtained_from_named_sequence()
        {
            var property = CreateConventionModelBuilder()
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForXuGuDbUseSequenceHiLo("DaneelOlivaw", "R")
                .Metadata;
        ...
        {
            var property = CreateConventionModelBuilder()
                .ForXuGuDbHasSequence("DaneelOlivaw", "R", b => b.IncrementsBy(11))
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForXuGuDbUseSequenceHiLo("DaneelOlivaw", "R")
                .Metadata;
        ...
        protected virtual ModelBuilder CreateConventionModelBuilder() => XuGuDbTestHelpers.Instance.CreateConventionBuilder();

        private static Property CreateProperty()
        {
            var entityType = new Model().AddEntityType("MyType");
            var property = entityType.AddProperty("MyProperty", typeof(string));
            entityType.XuGuDb().TableName = "MyTable";
        ...
        {
            var modelBuilder = XuGuDbTestHelpers.Instance.CreateConventionBuilder();
            ...
            modelBuilder.Entity<Led>(b =>
                {
                    b.Property(e => e.Zeppelin).ForXuGuDbUseSequenceHiLo("Heaven");
                    b.Property(e => e.Stairway).ForXuGuDbUseSequenceHiLo("Heaven");
                    b.Property(e => e.WholeLotta).ForXuGuDbUseSequenceHiLo("Rosie");
                });
