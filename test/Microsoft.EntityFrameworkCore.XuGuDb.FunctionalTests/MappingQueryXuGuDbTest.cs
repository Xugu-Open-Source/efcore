...
{
    public class MappingQueryXuGuDbTest : MappingQueryTestBase, IClassFixture<MappingQueryXuGuDbFixture>
    {
        [Fact]
 ...
 FROM `SYSDBA`.`Orders` `o`",
        ...
        private readonly MappingQueryXuGuDbFixture _fixture;

        public MappingQueryXuGuDbTest(MappingQueryXuGuDbFixture fixture)
        {
            _fixture = fixture;
        }
