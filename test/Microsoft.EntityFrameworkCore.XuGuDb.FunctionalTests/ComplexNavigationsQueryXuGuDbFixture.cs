...
{
    public class ComplexNavigationsQueryXuGuDbFixture
        : ComplexNavigationsQueryRelationalFixture<XuGuDbTestStore>
    {
        ...
        private readonly string _connectionString
            = XuGuDbTestStore.CreateConnectionString(DatabaseName);

        public ComplexNavigationsQueryXuGuDbFixture()
        {
        ...
        public override ComplexNavigationsContext CreateContext(XuGuDbTestStore testStore)
        {
            var optionsBuilder = new DbContextOptionsBuilder()
                .UseXuGuDb(testStore.Connection, b => b.ApplyConfiguration())
                .UseInternalServiceProvider(_serviceProvider);
