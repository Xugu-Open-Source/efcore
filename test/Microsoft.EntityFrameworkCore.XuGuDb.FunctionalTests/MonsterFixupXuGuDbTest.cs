...
{
    public class MonsterFixupXuGuDbTest : MonsterFixupTestBase
    {
        ...
        protected override DbContextOptions CreateOptions(string databaseName)
        {
            ...
            optionsBuilder.UseXuGuDb(CreateConnectionString(databaseName));
        ...
        public override void OnModelCreating<TMessage, TProductPhoto, TProductReview>(ModelBuilder builder)
        {
            ...
            builder.Entity<TMessage>().Property(e => e.MessageId).UseXuGuDbIdentityColumn();
            builder.Entity<TProductPhoto>().Property(e => e.PhotoId).UseXuGuDbIdentityColumn();
            builder.Entity<TProductReview>().Property(e => e.ReviewId).UseXuGuDbIdentityColumn();
        }
    }
}
