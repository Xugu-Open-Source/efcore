...
{
    public class IncludeXuGuDbTest : IncludeTestBase<NorthwindQueryXuGuDbFixture>
    {
        private bool SupportsOffset => TestEnvironment.GetFlag(nameof(XuGuDbCondition.SupportsOffset)) ?? true;

        public IncludeXuGuDbTest(NorthwindQueryXuGuDbFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
