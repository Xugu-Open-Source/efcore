...
{
    public class MigrationsXuGuDbFixture : MigrationsFixtureBase
    {
        private readonly DbContextOptions _options;

        public MigrationsXuGuDbFixture()
        {
            ...
            _options = new DbContextOptionsBuilder()
                ...
                .UseXuGuDb(connectionStringBuilder.ConnectionString).Options;
        }
        ...
        private class Migration3 : Migration
        {
            protected override void Up(MigrationBuilder migrationBuilder)
            {
                if (ActiveProvider == "Microsoft.EntityFrameworkCore.XuGuDb")
                {
