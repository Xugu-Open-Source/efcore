...
{
    public class InheritanceRelationshipsQueryXuGuDbTest : InheritanceRelationshipsQueryTestBase<XuGuDbTestStore, InheritanceRelationshipsQueryXuGuDbFixture>
    {
        public InheritanceRelationshipsQueryXuGuDbTest(InheritanceRelationshipsQueryXuGuDbFixture fixture)
            : base(fixture)
        {
        }
