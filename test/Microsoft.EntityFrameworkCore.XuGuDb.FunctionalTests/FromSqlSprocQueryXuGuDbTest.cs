...
{
    public class FromSqlSprocQueryXuGuDbTest : FromSqlSprocQueryTestBase<NorthwindSprocQueryXuGuDbFixture>
    {
...
`SYSDBA`.`TenMostExpensiveProducts`",
        ...
        public FromSqlSprocQueryXuGuDbTest(
            NorthwindSprocQueryXuGuDbFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
