...
namespace Microsoft.EntityFrameworkCore.XuGuDb.FunctionalTests
{
    ...
    public class RowNumberPagingTest : QueryTestBase<NorthwindRowNumberPagingQueryXuGuDbFixture>, IDisposable
    {
        public RowNumberPagingTest(NorthwindRowNumberPagingQueryXuGuDbFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
