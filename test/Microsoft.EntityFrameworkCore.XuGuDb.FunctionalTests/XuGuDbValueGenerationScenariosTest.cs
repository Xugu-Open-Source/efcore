...
{
    public class XuGuDbValueGenerationScenariosTest
    {
        // Positive cases
        ...
        public abstract class ContextBase : DbContext
        {
            ...
            {
                var name = GetType().FullName.Substring((GetType().Namespace + nameof(XuGuDbValueGenerationScenariosTest)).Length + 2);
                optionsBuilder.UseXuGuDb(XuGuDbTestStore.CreateConnectionString(name));
            }
        }
