...
{
    public class XuGuDbEndToEndTest : IClassFixture<XuGuDbFixture>
    {
        [Fact]
        ...
        private class NumNumContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXuGuDb(XuGuDbTestStore.CreateConnectionString("NumNum"));
        ...
        private class SchemaContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXuGuDb(Connection).UseInternalServiceProvider(_serviceProvider);
        ...
        public XuGuDbEndToEndTest(XuGuDbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private class NorthwindContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbNorthwindContext.ConnectionString)
