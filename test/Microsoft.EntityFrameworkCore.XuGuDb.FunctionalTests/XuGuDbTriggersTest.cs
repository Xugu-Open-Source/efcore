...
{
    public class XuGuDbTriggersTest : IClassFixture<XuGuDbTriggersTest.XuGuDbTriggersFixture>, IDisposable
    {
        [Fact]
        ...
        private readonly XuGuDbTriggersFixture _fixture;
        private readonly XuGuDbTestStore _testStore;

        public XuGuDbTriggersTest(XuGuDbTriggersFixture fixture)
        {
            _fixture = fixture;
        ...
        public class XuGuDbTriggersFixture
        {
            private readonly IServiceProvider _serviceProvider;

            public XuGuDbTriggersFixture()
            {
                _serviceProvider
            ...
            public virtual XuGuDbTestStore GetTestStore()
            {
                var testStore = XuGuDbTestStore.CreateScratch();
...
END");
            ...
            public TriggersContext CreateContext(XuGuDbTestStore testStore)
                => new TriggersContext(new DbContextOptionsBuilder()
                    .EnableSensitiveDataLogging()
                    .UseInternalServiceProvider(_serviceProvider)
                    .UseXuGuDb(testStore.Connection).Options);
        }
