...
{
    public class XuGuDbDatabaseCreationTest
    {
        [Fact]
        ...
        private static async Task RunDatabaseCreationTest(XuGuDbTestStore testStore, bool async)
        {
        ...
        private static IServiceProvider CreateServiceProvider()
            => new ServiceCollection().AddEntityFrameworkXuGuDb().BuildServiceProvider();

        private class BloggingContext : DbContext
        {
            private readonly XuGuDbTestStore _testStore;

            public BloggingContext(XuGuDbTestStore testStore)
            {
