...
namespace Microsoft.EntityFrameworkCore.XuGuDb.FunctionalTests
{
    ...
    public class AsyncQueryXuGuDbTest : AsyncQueryTestBase<NorthwindQueryXuGuDbFixture>
    {
        ...
        public AsyncQueryXuGuDbTest(NorthwindQueryXuGuDbFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
