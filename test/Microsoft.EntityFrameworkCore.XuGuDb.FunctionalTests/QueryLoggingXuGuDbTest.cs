...
{
    public class QueryLoggingXuGuDbTest : IClassFixture<NorthwindQueryXuGuDbFixture>
    {
        [Fact]
...
(QueryContext queryContext) => IEnumerable<Customer> _Include(
    ...
    querySourceRequiresTracking: True
        ...
        private readonly NorthwindQueryXuGuDbFixture _fixture;

        public QueryLoggingXuGuDbTest(NorthwindQueryXuGuDbFixture fixture)
        {
            _fixture = fixture;
        }
