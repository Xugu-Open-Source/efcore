...
{
    public class QueryBugsTest : IClassFixture<XuGuDbFixture>
    {
        [Fact]
        public async Task Multiple_optional_navs_should_not_deadlock_bug_5481()
        {
            using (var testStore = XuGuDbTestStore.CreateScratch())
            {
        ...
        private class DeadlockContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXuGuDb(_connectionString);
        ...
        private class MyContext603 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro603"))
...
ORDER BY `o`.`CustomerFirstName`, `o`.`CustomerLastName`";
 ...
 FROM `Order` `o`
LEFT JOIN `Customer` `c` ON (`o`.`CustomerFirstName` = `c`.`FirstName`) AND (`o`.`CustomerLastName` = `c`.`LastName`)";
        ...
        public class MyContext925 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    ...
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro925"))
                    .UseInternalServiceProvider(_serviceProvider);
...
Queen of the Andals and the Rhoynar and the First Men, Khaleesi of the Great Grass Sea, Breaker of Chains, and Mother of Dragons"
        ...
        public class MyContext963 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro963"))
                    .UseInternalServiceProvider(_serviceProvider);
        ...
        public void Execute1742(CustomerDetails_1742 details)
        {
            ...
            using (var ctx = new MyContext925(serviceProvider))
            {
                ...
                const string expectedSql
                    = @":__firstName_0: Foo (Size = 450) (DbType = Object)
:__8__locals1_details_LastName_1: Bar (Size = 450) (DbType = Object)
...
SELECT `c`.`FirstName`, `c`.`LastName`
 ...
 WHERE (`c`.`FirstName` = :__firstName_0) AND (`c`.`LastName` = :__8__locals1_details_LastName_1)";
        ...
        private readonly XuGuDbFixture _fixture;

        public QueryBugsTest(XuGuDbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public class MyContext3758 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro3758"))
                    .UseInternalServiceProvider(_serviceProvider);
        ...
        public class MyContext3409 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro3409"))
                    .UseInternalServiceProvider(_serviceProvider);
        ...
        public class MyContext3101 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXuGuDb(XuGuDbTestStore.CreateConnectionString("Repro3101"));
        ...
        {
            var connectionString = XuGuDbTestStore.CreateConnectionString(databaseName);
            XuGuDbTestStore.GetOrCreateShared(databaseName, () =>
                {
                    var optionsBuilder = new DbContextOptionsBuilder();
                    optionsBuilder.UseXuGuDb(connectionString);
