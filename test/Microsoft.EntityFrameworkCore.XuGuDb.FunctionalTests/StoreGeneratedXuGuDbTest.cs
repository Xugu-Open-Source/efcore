...
{
    public class StoreGeneratedXuGuDbTest
        : StoreGeneratedTestBase<XuGuDbTestStore, StoreGeneratedXuGuDbTest.StoreGeneratedXuGuDbFixture>
    {
        public StoreGeneratedXuGuDbTest(StoreGeneratedXuGuDbFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class StoreGeneratedXuGuDbFixture : StoreGeneratedFixtureBase
        {
            private const string DatabaseName = "StoreGeneratedTest";

            private readonly IServiceProvider _serviceProvider;

            public StoreGeneratedXuGuDbFixture()
            {
                ...
                return XuGuDbTestStore.GetOrCreateShared(DatabaseName, () =>
                    {
                        var optionsBuilder = new DbContextOptionsBuilder()
                            .UseXuGuDb(XuGuDbTestStore.CreateConnectionString(DatabaseName), b => b.MaxBatchSize(1))
