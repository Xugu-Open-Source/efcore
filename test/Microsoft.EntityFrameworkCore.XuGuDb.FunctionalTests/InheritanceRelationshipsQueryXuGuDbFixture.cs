...
{
    public class InheritanceRelationshipsQueryXuGuDbFixture : InheritanceRelationshipsQueryRelationalFixture<XuGuDbTestStore>
    {
        ...
        public InheritanceRelationshipsQueryXuGuDbFixture()
        {
        ...
        public override InheritanceRelationshipsContext CreateContext(XuGuDbTestStore testStore)
        {
            var optionsBuilder = new DbContextOptionsBuilder()
