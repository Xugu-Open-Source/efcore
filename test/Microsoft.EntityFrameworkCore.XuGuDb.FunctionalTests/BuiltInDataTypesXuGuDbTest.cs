...
{
    public class BuiltInDataTypesXuGuDbTest : BuiltInDataTypesTestBase<BuiltInDataTypesXuGuDbFixture>
    {
        public BuiltInDataTypesXuGuDbTest(BuiltInDataTypesXuGuDbFixture fixture)
            : base(fixture)
        {
        }
