...
{
    public class TestXuGuDbModelSource : XuGuDbModelSource
    {
        private readonly TestModelSource _testModelSource;

        public TestXuGuDbModelSource(
        ...
        public static Func<IServiceProvider, XuGuDbModelSource> GetFactory(Action<ModelBuilder> onModelCreating)
            => p => new TestXuGuDbModelSource(
                onModelCreating,
