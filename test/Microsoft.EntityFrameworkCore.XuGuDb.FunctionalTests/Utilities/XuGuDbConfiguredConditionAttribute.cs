...
namespace Microsoft.EntityFrameworkCore.XuGuDb.FunctionalTests.Utilities
{
    ...
    public class XuGuDbConfiguredConditionAttribute : Attribute, ITestCondition
    {
        private static readonly string _dataSource = new SqlConnectionStringBuilder(XuGuDbTestStore.CreateConnectionString("sample")).DataSource;
