    ...
    public class ComputedColumnTest
    {
        ...
        private class Context : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXuGuDb(XuGuDbTestStore.CreateConnectionString(_databaseName))
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder.Entity<Entity>()
                    .Property(e => e.P4)
                    .ForXuGuDbHasComputedColumnSql("P1 + P2");

                modelBuilder.Entity<Entity>()
                    .Property(e => e.P5)
                    .ForXuGuDbHasComputedColumnSql("P1 + P3");
            }
        }
        ...
        private class NullableContext : DbContext
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
                => modelBuilder.Entity<EnumItem>()
                    ...
                    .ForXuGuDbHasComputedColumnSql("FlagEnum | OptionalFlagEnum");
        }
