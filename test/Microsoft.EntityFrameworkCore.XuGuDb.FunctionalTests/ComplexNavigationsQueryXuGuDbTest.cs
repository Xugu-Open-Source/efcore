...
namespace Microsoft.EntityFrameworkCore.XuGuDb.FunctionalTests
{
    ...
    public class ComplexNavigationsQueryXuGuDbTest : ComplexNavigationsQueryTestBase<XuGuDbTestStore, ComplexNavigationsQueryXuGuDbFixture>
    {
        public ComplexNavigationsQueryXuGuDbTest(
            ComplexNavigationsQueryXuGuDbFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        private bool SupportsOffset => TestEnvironment.GetFlag(nameof(XuGuDbCondition.SupportsOffset)) ?? true;
 ...
 FROM `Level1` `l`
LEFT JOIN `Level2` `l.OneToOne_Optional_FK` ON `l`.`Id` = `l.OneToOne_Optional_FK`.`Level1_Optional_Id`
ORDER BY `l`.`Id`", 
                Sql);
        }
...
ORDER BY `l`.`Id`", 
		...
		public override void Key_equality_using_property_method_required()
        {
            ...
            Assert.Equal(
                @"SELECT `l`.`Id`, `l`.`Name`, `l`.`OneToMany_Optional_Self_InverseId`, `l`.`OneToMany_Required_Self_InverseId`, `l`.`OneToOne_Optional_SelfId`
 FROM `Level1` `l`
INNER JOIN `Level2` `l.OneToOne_Required_FK` ON `l`.`Id` = `l.OneToOne_Required_FK`.`Level1_Required_Id`
    ...
    SELECT DISTINCT `l`.`OneToMany_Optional_InverseId`, `l`.`Id`
     ...
     WHERE EXISTS (
        SELECT 1
         FROM `Level1` `e`
         WHERE `l`.`OneToMany_Optional_InverseId` = `e`.`Id`)
) `l1` ON `l0`.`OneToMany_Optional_InverseId` = `l1`.`Id`
...
INNER JOIN `Level2` `l2` ON `l0`.`OneToMany_Required_InverseId` = `l2`.`Id`
...
SELECT `l3`.`Id`, `l3`.`Level2_Optional_Id`, `l3`.`Level2_Required_Id`, `l3`.`Name`, `l3`.`OneToMany_Optional_InverseId`, `l3`.`OneToMany_Optional_Self_InverseId`, `l3`.`OneToMany_Required_InverseId`, `l3`.`OneToMany_Required_Self_InverseId`, `l3`.`OneToOne_Optional_PK_InverseId`, `l3`.`OneToOne_Optional_SelfId`
 FROM `Level3` `l3`
INNER JOIN (
    SELECT DISTINCT `l1`.`OneToMany_Optional_InverseId`, `l1`.`Id`, `l2`.`Id` `Id0`
     FROM `Level3` `l0`
    INNER JOIN (
        SELECT DISTINCT `l`.`OneToMany_Optional_InverseId`, `l`.`Id`
         FROM `Level2` `l`
    ...
    INNER JOIN `Level2` `l2` ON `l0`.`OneToMany_Required_InverseId` = `l2`.`Id`
) `l20` ON `l3`.`OneToMany_Optional_InverseId` = `l20`.`Id0`
ORDER BY `l20`.`OneToMany_Optional_InverseId`, `l20`.`Id`, `l20`.`Id0`",
 ...
 FROM `ComplexNavigationField` `x`
LEFT JOIN `ComplexNavigationString` `c` ON `x`.`LabelDefaultText` = `c`.`DefaultText`
LEFT JOIN `ComplexNavigationString` `c2` ON `x`.`PlaceholderDefaultText` = `c2`.`DefaultText`
...
SELECT `c0`.`Text`, `c0`.`ComplexNavigationStringDefaultText`, `c0`.`LanguageName`, `c1`.`Name`, `c1`.`CultureString`
 FROM `ComplexNavigationGlobalization` `c0`
LEFT JOIN `ComplexNavigationLanguage` `c1` ON `c0`.`LanguageName` = `c1`.`Name`
 WHERE EXISTS (
    SELECT 1
     FROM `ComplexNavigationField` `x`
    LEFT JOIN `ComplexNavigationString` `c` ON `x`.`LabelDefaultText` = `c`.`DefaultText`
...
SELECT `c3`.`Text`, `c3`.`ComplexNavigationStringDefaultText`, `c3`.`LanguageName`, `c4`.`Name`, `c4`.`CultureString`
 FROM `ComplexNavigationGlobalization` `c3`
LEFT JOIN `ComplexNavigationLanguage` `c4` ON `c3`.`LanguageName` = `c4`.`Name`
 WHERE EXISTS (
    SELECT 1
     FROM `ComplexNavigationField` `x`
    LEFT JOIN `ComplexNavigationString` `c` ON `x`.`LabelDefaultText` = `c`.`DefaultText`
...
ORDER BY `c3`.`ComplexNavigationStringDefaultText`",
		...
		public override void Join_navigation_key_access_optional()
        {
            ...
            Assert.Equal(
                @"SELECT `e1`.`Id`, `e2`.`Id`
 FROM `Level1` `e1`
INNER JOIN `Level2` `e2` ON `e1`.`Id` = (
    SELECT TOP(1) `subQuery0`.`Id`
     FROM `Level1` `subQuery0`
     WHERE `subQuery0`.`Id` = `e2`.`Level1_Optional_Id`
		...
		public override void Join_navigation_key_access_required()
        {
            ...
            Assert.Equal(
                @"SELECT `e1`.`Id`, `e2`.`Id`
 FROM `Level1` `e1`
INNER JOIN `Level2` `e2` ON `e1`.`Id` = `e2`.`Level1_Required_Id`",
                Sql);
        }
 ...
 FROM `Level2` `e2`
LEFT JOIN `Level1` `e2.OneToOne_Optional_PK_Inverse` ON `e2`.`OneToOne_Optional_PK_InverseId` = `e2.OneToOne_Optional_PK_Inverse`.`Id`
ORDER BY `e2`.`OneToOne_Optional_PK_InverseId`",
 ...
 FROM `Level1` `e1`
INNER JOIN `Level2` `e1.OneToOne_Required_FK` ON `e1`.`Id` = `e1.OneToOne_Required_FK`.`Level1_Required_Id`
 ...
 FROM `Level1` `e1`
LEFT JOIN `Level2` `e1.OneToOne_Optional_FK` ON `e1`.`Id` = `e1.OneToOne_Optional_FK`.`Level1_Optional_Id`
ORDER BY `e1`.`Id`",
                Sql);
        }
 ...
 FROM `Level1` `e1`
INNER JOIN `Level2` `e1.OneToOne_Required_FK` ON `e1`.`Id` = `e1.OneToOne_Required_FK`.`Level1_Required_Id`
LEFT JOIN `Level3` `e1.OneToOne_Required_FK.OneToOne_Optional_FK` ON `e1.OneToOne_Required_FK`.`Id` = `e1.OneToOne_Required_FK.OneToOne_Optional_FK`.`Level2_Optional_Id`
ORDER BY `e1.OneToOne_Required_FK`.`Id`",
		...
		public override void Join_navigation_in_inner_selector_translated_to_subquery()
        {
            ...
            Assert.Equal(
                @"SELECT `e2`.`Id`, `e1`.`Id`
 FROM `Level2` `e2`
INNER JOIN `Level1` `e1` ON `e2`.`Id` = (
    SELECT TOP(1) `subQuery0`.`Id`
     FROM `Level2` `subQuery0`
...
INNER JOIN `Level3` `e3` ON `e2`.`Id` = (
    SELECT TOP(1) `subQuery2`.`Id`
     FROM `Level2` `subQuery2`
 ...
 FROM `Level2` `e2`
INNER JOIN `Level1` `e1` ON `e2`.`Name` = (
...
INNER JOIN `Level1` `e2` ON `e1`.`Id` = (
 ...
 FROM `Level2` `subQuery`
LEFT JOIN `Level3` `subQuery.OneToOne_Optional_FK` ON `subQuery`.`Id` = `subQuery.OneToOne_Optional_FK`.`Level2_Optional_Id`
ORDER BY `subQuery`.`Id`",
 ...
 FROM `Level4` `subQuery.OneToOne_Optional_FK.OneToOne_Required_PK`",
                Sql);
...
ORDER BY `subQuery`.`Id`",
 ...
 FROM `Level1` `e`
LEFT JOIN `Level2` `l1` ON `l1`.`Level1_Optional_Id` = `e`.`Id`
ORDER BY `e`.`Id`, `l1`.`Id`
...
SELECT `l`.`Id`, `l`.`Level1_Optional_Id`, `l`.`Level1_Required_Id`, `l`.`Name`, `l`.`OneToMany_Optional_InverseId`, `l`.`OneToMany_Optional_Self_InverseId`, `l`.`OneToMany_Required_InverseId`, `l`.`OneToMany_Required_Self_InverseId`, `l`.`OneToOne_Optional_PK_InverseId`, `l`.`OneToOne_Optional_SelfId`, `l0`.`Id`, `l0`.`Level2_Optional_Id`, `l0`.`Level2_Required_Id`, `l0`.`Name`, `l0`.`OneToMany_Optional_InverseId`, `l0`.`OneToMany_Optional_Self_InverseId`, `l0`.`OneToMany_Required_InverseId`, `l0`.`OneToMany_Required_Self_InverseId`, `l0`.`OneToOne_Optional_PK_InverseId`, `l0`.`OneToOne_Optional_SelfId`
 FROM `Level2` `l`
LEFT JOIN `Level3` `l0` ON `l0`.`Level2_Optional_Id` = `l`.`Id`
 WHERE EXISTS (
    SELECT 1
     FROM `Level1` `e`
     WHERE `l`.`OneToMany_Optional_InverseId` = `e`.`Id`)
...
SELECT `l2`.`Id`, `l2`.`Level2_Optional_Id`, `l2`.`Level2_Required_Id`, `l2`.`Name`, `l2`.`OneToMany_Optional_InverseId`, `l2`.`OneToMany_Optional_Self_InverseId`, `l2`.`OneToMany_Required_InverseId`, `l2`.`OneToMany_Required_Self_InverseId`, `l2`.`OneToOne_Optional_PK_InverseId`, `l2`.`OneToOne_Optional_SelfId`
 FROM `Level3` `l2`
INNER JOIN (
    SELECT DISTINCT `e`.`Id`, `l1`.`Id` `Id0`
     FROM `Level1` `e`
    LEFT JOIN `Level2` `l1` ON `l1`.`Level1_Optional_Id` = `e`.`Id`
) `l10` ON `l2`.`OneToMany_Optional_InverseId` = `l10`.`Id0`
ORDER BY `l10`.`Id`, `l10`.`Id0`",
 ...
 FROM `Level1` `e`
LEFT JOIN `Level1` `l1` ON `e`.`OneToOne_Optional_SelfId` = `l1`.`Id`
ORDER BY `e`.`Id`, `l1`.`Id`
...
SELECT `l`.`Id`, `l`.`Name`, `l`.`OneToMany_Optional_Self_InverseId`, `l`.`OneToMany_Required_Self_InverseId`, `l`.`OneToOne_Optional_SelfId`, `l0`.`Id`, `l0`.`Name`, `l0`.`OneToMany_Optional_Self_InverseId`, `l0`.`OneToMany_Required_Self_InverseId`, `l0`.`OneToOne_Optional_SelfId`
 FROM `Level1` `l`
LEFT JOIN `Level1` `l0` ON `l`.`OneToOne_Optional_SelfId` = `l0`.`Id`
 WHERE EXISTS (
    SELECT 1
     FROM `Level1` `e`
...
ORDER BY `l10`.`Id`, `l10`.`Id0`",
 ...
 FROM `Level1` `e`
LEFT JOIN `Level2` `e.OneToOne_Optional_FK` ON `e`.`Id` = `e.OneToOne_Optional_FK`.`Level1_Optional_Id`
ORDER BY `e`.`Id`",
                Sql);
        }
 ...
 FROM `Level1` `l1`
LEFT JOIN `Level2` `l2` ON `l1`.`Id` = `l2`.`Level1_Optional_Id`
ORDER BY `l1`.`Id`",
                Sql);
        }
...
ORDER BY `l1`.`Id`",
 ...
 FROM `Level2` `e`
LEFT JOIN `Level1` `e.OneToOne_Optional_FK_Inverse` ON `e`.`Level1_Optional_Id` = `e.OneToOne_Optional_FK_Inverse`.`Id`
...
ORDER BY `e`.`Id`",
 ...
 FROM `Level1` `l1`
LEFT JOIN `Level2` `l2Left` ON `l1`.`Id` = `l2Left`.`Level1_Optional_Id`
ORDER BY `l1`.`Id`",
                Sql);
        }
...
ORDER BY `l1`.`Id`",
 ...
 FROM `Level3` `e.OneToOne_Optional_FK.OneToOne_Optional_FK`",
                Sql);
...
ORDER BY `e`.`Id`",
 ...
 FROM `Level3` `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`", Sql);
 ...
 FROM `Level1` `l1`
LEFT JOIN `Level2` `l1.OneToOne_Optional_FK` ON `l1`.`Id` = `l1.OneToOne_Optional_FK`.`Level1_Optional_Id`
ORDER BY `l1`.`Id`", Sql);
        }
		...
		public override void Where_multiple_nav_prop_reference_optional_member_compared_to_null()
        {
            ...
            Assert.Contains(
                @"SELECT `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`Id`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`Level2_Optional_Id`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`Level2_Required_Id`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`Name`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToMany_Optional_InverseId`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToMany_Optional_Self_InverseId`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToMany_Required_InverseId`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToMany_Required_Self_InverseId`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToOne_Optional_PK_InverseId`, `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`.`OneToOne_Optional_SelfId`
 FROM `Level3` `l1.OneToOne_Optional_FK.OneToOne_Optional_FK`",
                Sql);
...
ORDER BY `l1`.`Id`",
 ...
 FROM `Level3` `l3`
LEFT JOIN `Level2` `l3.OneToOne_Optional_FK_Inverse` ON `l3`.`Level2_Optional_Id` = `l3.OneToOne_Optional_FK_Inverse`.`Id`
...
ORDER BY `l3`.`Level2_Optional_Id`",
 ...
 FROM `Level4` `e.OneToOne_Optional_FK.OneToOne_Required_FK.OneToOne_Required_FK`",
                Sql);
 ...
 FROM `Level3` `e.OneToOne_Optional_FK.OneToOne_Required_FK`",
                Sql);
...
ORDER BY `e`.`Id`",
 ...
 FROM `Level1` `e`
INNER JOIN `Level2` `e.OneToOne_Required_FK` ON `e`.`Id` = `e.OneToOne_Required_FK`.`Level1_Required_Id`
INNER JOIN `Level3` `e.OneToOne_Required_FK.OneToOne_Required_FK` ON `e.OneToOne_Required_FK`.`Id` = `e.OneToOne_Required_FK.OneToOne_Required_FK`.`Level2_Required_Id`",
                Sql);
        }
 ...
 FROM `Level3` `l1.OneToOne_Optional_FK.OneToOne_Required_FK`",
                Sql);
...
ORDER BY `l1`.`Id`",
 ...
 FROM `Level2` `l1.OneToOne_Optional_FK`",
                Sql);
 ...
 FROM `Level1` `l1`
INNER JOIN `Level2` `l1.OneToOne_Required_FK` ON `l1`.`Id` = `l1.OneToOne_Required_FK`.`Level1_Required_Id`
LEFT JOIN `Level3` `l1.OneToOne_Required_FK.OneToOne_Optional_FK` ON `l1.OneToOne_Required_FK`.`Id` = `l1.OneToOne_Required_FK.OneToOne_Optional_FK`.`Level2_Optional_Id`
...
INNER JOIN `Level2` `e.OneToOne_Required_FK` ON `e`.`Id` = `e.OneToOne_Required_FK`.`Level1_Required_Id`
INNER JOIN `Level3` `e.OneToOne_Required_FK.OneToOne_Required_FK` ON `e.OneToOne_Required_FK`.`Id` = `e.OneToOne_Required_FK.OneToOne_Required_FK`.`Level2_Required_Id`
LEFT JOIN `Level3` `e.OneToOne_Required_FK.OneToOne_Optional_FK` ON `e.OneToOne_Required_FK`.`Id` = `e.OneToOne_Required_FK.OneToOne_Optional_FK`.`Level2_Optional_Id`
...
ORDER BY `l1`.`Id`",
 ...
 FROM `Level1` `e`
LEFT JOIN `Level2` `e.OneToOne_Optional_FK` ON `e`.`Id` = `e.OneToOne_Optional_FK`.`Level1_Optional_Id`
LEFT JOIN `Level2` `l` ON `l`.`Level1_Optional_Id` = `e`.`Id`
ORDER BY `e`.`Id`",
                Sql);
        }
...
SELECT `l0`.`Id`, `l0`.`Level2_Optional_Id`, `l0`.`Level2_Required_Id`, `l0`.`Name`, `l0`.`OneToMany_Optional_InverseId`, `l0`.`OneToMany_Optional_Self_InverseId`, `l0`.`OneToMany_Required_InverseId`, `l0`.`OneToMany_Required_Self_InverseId`, `l0`.`OneToOne_Optional_PK_InverseId`, `l0`.`OneToOne_Optional_SelfId`, `l2`.`Id`, `l2`.`Level3_Optional_Id`, `l2`.`Level3_Required_Id`, `l2`.`Name`, `l2`.`OneToMany_Optional_InverseId`, `l2`.`OneToMany_Optional_Self_InverseId`, `l2`.`OneToMany_Required_InverseId`, `l2`.`OneToMany_Required_Self_InverseId`, `l2`.`OneToOne_Optional_PK_InverseId`, `l2`.`OneToOne_Optional_SelfId`
 FROM `Level3` `l0`
INNER JOIN (
    SELECT DISTINCT `e`.`Id`, `l`.`Id` `Id0`
     FROM `Level1` `e`
    LEFT JOIN `Level2` `e.OneToOne_Optional_FK` ON `e`.`Id` = `e.OneToOne_Optional_FK`.`Level1_Optional_Id`
    LEFT JOIN `Level2` `l` ON `l`.`Level1_Optional_Id` = `e`.`Id`
) `l1` ON `l0`.`OneToMany_Required_InverseId` = `l1`.`Id0`
LEFT JOIN `Level4` `l2` ON `l2`.`Level3_Required_Id` = `l0`.`Id`
...
LEFT JOIN (
    SELECT `e1`.`Id`, `e1`.`Level1_Optional_Id`, `e1`.`Level1_Required_Id`, `e1`.`Name`, `e1`.`OneToMany_Optional_InverseId`, `e1`.`OneToMany_Optional_Self_InverseId`, `e1`.`OneToMany_Required_InverseId`, `e1`.`OneToMany_Required_Self_InverseId`, `e1`.`OneToOne_Optional_PK_InverseId`, `e1`.`OneToOne_Optional_SelfId`
     FROM `Level2` `e1`
) `t` ON `e`.`Id` = `t`.`Level1_Optional_Id`
LEFT JOIN `Level3` `l1` ON `l1`.`Id` = `t`.`Id`
...
ORDER BY `l`.`OneToMany_Optional_InverseId`",
 ...
 FROM `Level2` `subQuery2`
LEFT JOIN `Level3` `subQuery3` ON `subQuery2`.`Id` = `subQuery3`.`Level2_Optional_Id`
...
ORDER BY `subQuery2`.`Id`",
 ...
 FROM `Level1` `l1`
INNER JOIN `Level2` `l1.OneToMany_Optional` ON `l1`.`Id` = `l1.OneToMany_Optional`.`OneToMany_Optional_InverseId`",
                Sql);
        }
...
INNER JOIN `Level2` `l1.OneToMany_Optional` ON `l1`.`Id` = `l1.OneToMany_Optional`.`OneToMany_Optional_InverseId`",
 ...
 FROM `Level1` `e`
INNER JOIN `Level2` `e.OneToMany_Optional` ON `e`.`Id` = `e.OneToMany_Optional`.`OneToMany_Optional_InverseId`
 WHERE `e`.`Id` = 1",
                Sql);
        }
...
INNER JOIN `Level2` `l1.OneToMany_Optional` ON `l1`.`Id` = `l1.OneToMany_Optional`.`OneToMany_Optional_InverseId`
 ...
 FROM `Level1` `l1`
INNER JOIN `Level2` `l1.OneToOne_Required_FK` ON `l1`.`Id` = `l1.OneToOne_Required_FK`.`Level1_Required_Id`
INNER JOIN `Level3` `l1.OneToOne_Required_FK.OneToMany_Optional` ON `l1.OneToOne_Required_FK`.`Id` = `l1.OneToOne_Required_FK.OneToMany_Optional`.`OneToMany_Optional_InverseId`",
                Sql);
        }
 ...
 FROM `Level1` `l1`
INNER JOIN `Level2` `l1.OneToOne_Optional_FK` ON `l1`.`Id` = `l1.OneToOne_Optional_FK`.`Level1_Optional_Id`
INNER JOIN `Level3` `l1.OneToOne_Optional_FK.OneToMany_Optional` ON `l1.OneToOne_Optional_FK`.`Id` = `l1.OneToOne_Optional_FK.OneToMany_Optional`.`OneToMany_Optional_InverseId`",
                Sql);
        }
 ...
 FROM `Level1` `e`
INNER JOIN `Level2` `e.OneToMany_Optional` ON `e`.`Id` = `e.OneToMany_Optional`.`OneToMany_Optional_InverseId`
INNER JOIN `Level3` `e.OneToMany_Optional.OneToMany_Optional` ON `e.OneToMany_Optional`.`Id` = `e.OneToMany_Optional.OneToMany_Optional`.`OneToMany_Optional_InverseId`",
                Sql);
        }
 ...
 FROM `Level1` `l1`
INNER JOIN `Level2` `l1.OneToMany_Optional` ON `l1`.`Id` = `l1.OneToMany_Optional`.`OneToMany_Optional_InverseId`
LEFT JOIN `Level3` `l1.OneToMany_Optional.OneToOne_Optional_FK` ON `l1.OneToMany_Optional`.`Id` = `l1.OneToMany_Optional.OneToOne_Optional_FK`.`Level2_Optional_Id`
     ...
     WHERE `l1.OneToOne_Required_FK`.`Id` = `l`.`OneToMany_Optional_InverseId`
		...
		public override void Where_navigation_property_to_collection_of_original_entity_type()
        {
            ...
            Assert.Equal(
                @"SELECT `l2`.`Id`, `l2`.`Level1_Optional_Id`, `l2`.`Level1_Required_Id`, `l2`.`Name`, `l2`.`OneToMany_Optional_InverseId`, `l2`.`OneToMany_Optional_Self_InverseId`, `l2`.`OneToMany_Required_InverseId`, `l2`.`OneToMany_Required_Self_InverseId`, `l2`.`OneToOne_Optional_PK_InverseId`, `l2`.`OneToOne_Optional_SelfId`
 FROM `Level2` `l2`
INNER JOIN `Level1` `l2.OneToMany_Required_Inverse` ON `l2`.`OneToMany_Required_InverseId` = `l2.OneToMany_Required_Inverse`.`Id`
 WHERE (
    SELECT COUNT(*)
     FROM `Level2` `l`
...
SELECT `e`.`Id`, `e`.`Name`, `e`.`OneToMany_Optional_Self_InverseId`, `e`.`OneToMany_Required_Self_InverseId`, `e`.`OneToOne_Optional_SelfId`, `l`.`Id`, `l`.`Level1_Optional_Id`, `l`.`Level1_Required_Id`, `l`.`Name`, `l`.`OneToMany_Optional_InverseId`, `l`.`OneToMany_Optional_Self_InverseId`, `l`.`OneToMany_Required_InverseId`, `l`.`OneToMany_Required_Self_InverseId`, `l`.`OneToOne_Optional_PK_InverseId`, `l`.`OneToOne_Optional_SelfId`, `l2`.`Id`, `l2`.`Level1_Optional_Id`, `l2`.`Level1_Required_Id`, `l2`.`Name`, `l2`.`OneToMany_Optional_InverseId`, `l2`.`OneToMany_Optional_Self_InverseId`, `l2`.`OneToMany_Required_InverseId`, `l2`.`OneToMany_Required_Self_InverseId`, `l2`.`OneToOne_Optional_PK_InverseId`, `l2`.`OneToOne_Optional_SelfId`
 FROM `Level1` `e`
LEFT JOIN `Level2` `l` ON `l`.`Level1_Required_Id` = `e`.`Id`
LEFT JOIN `Level2` `l2` ON `l2`.`Level1_Required_Id` = `e`.`Id`
...
) `l20` ON `l3`.`OneToMany_Required_InverseId` = `l20`.`Id`
