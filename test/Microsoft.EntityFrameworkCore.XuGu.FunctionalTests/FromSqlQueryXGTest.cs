...
{
    public class FromSqlQueryXGTest : FromSqlQueryTestBase<NorthwindQueryXGFixture>
    {
...
CROSS JOIN (
 ...
 WHERE `c`.`CustomerID` = `o`.`CustomerID`",
        ...
        public override void From_sql_queryable_multiple_composed_with_closure_parameters()
        {
            ...
            Assert.Equal(
                @":__8__locals1_startDate_1: 1997-01-01 00:00:00 (DbType = DateTime)
:__8__locals1_endDate_2: 1998-01-01 00:00:00 (DbType = DateTime)
...
SELECT * FROM ""Employees"" WHERE ""ReportsTo"" = :p0 OR (""ReportsTo"" IS NULL AND :p0 IS NULL)",
        ...
        public override void From_sql_queryable_with_parameters_and_closure()
        {
            ...
            Assert.Equal(
                @":p0: London (Size = 8000) (DbType = AnsiString)
:__contactTitle_1: Sales Representative (Size = 8000) (DbType = AnsiString)
...
SELECT * FROM ""Customers"" WHERE ""City"" = :city AND ""ContactTitle"" = :p1",
        ...
        public FromSqlQueryXGTest(NorthwindQueryXGFixture fixture)
            : base(fixture)
        {
        }
