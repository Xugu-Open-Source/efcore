...
{
    public class DataAnnotationXGTest : DataAnnotationTestBase<XGTestStore, DataAnnotationXGFixture>
    {
        public DataAnnotationXGTest(DataAnnotationXGFixture fixture)
            : base(fixture)
        {
        }
