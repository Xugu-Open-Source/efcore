...
{
    public class QueryLoggingXGTest : IClassFixture<NorthwindQueryXGFixture>
    {
        [Fact]
...
(QueryContext queryContext) => IEnumerable<Customer> _Include(
    ...
    querySourceRequiresTracking: True
        ...
        private readonly NorthwindQueryXGFixture _fixture;

        public QueryLoggingXGTest(NorthwindQueryXGFixture fixture)
        {
            _fixture = fixture;
        }
