...
{
    public class XGTriggersTest : IClassFixture<XGTriggersTest.XGTriggersFixture>, IDisposable
    {
        [Fact]
        ...
        private readonly XGTriggersFixture _fixture;
        private readonly XGTestStore _testStore;

        public XGTriggersTest(XGTriggersFixture fixture)
        {
            _fixture = fixture;
        ...
        public class XGTriggersFixture
        {
            private readonly IServiceProvider _serviceProvider;

            public XGTriggersFixture()
            {
                _serviceProvider
            ...
            public virtual XGTestStore GetTestStore()
            {
                var testStore = XGTestStore.CreateScratch();
...
END");
            ...
            public TriggersContext CreateContext(XGTestStore testStore)
                => new TriggersContext(new DbContextOptionsBuilder()
                    .EnableSensitiveDataLogging()
                    .UseInternalServiceProvider(_serviceProvider)
                    .UseXG(testStore.Connection).Options);
        }
