...
namespace Microsoft.EntityFrameworkCore.XG.FunctionalTests
{
    ...
    public class AsyncQueryXGTest : AsyncQueryTestBase<NorthwindQueryXGFixture>
    {
        ...
        public AsyncQueryXGTest(NorthwindQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
