...
{
    public class QueryBugsTest : IClassFixture<XGFixture>
    {
        [Fact]
        public async Task Multiple_optional_navs_should_not_deadlock_bug_5481()
        {
            using (var testStore = XGTestStore.CreateScratch())
            {
        ...
        private class DeadlockContext : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXG(_connectionString);
        ...
        private class MyContext603 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXG(XGTestStore.CreateConnectionString("Repro603"))
        ...
        public class MyContext925 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    ...
                    .UseXG(XGTestStore.CreateConnectionString("Repro925"))
                    .UseInternalServiceProvider(_serviceProvider);
...
Queen of the Andals and the Rhoynar and the First Men, Khaleesi of the Great Grass Sea, Breaker of Chains, and Mother of Dragons"
        ...
        public class MyContext963 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXG(XGTestStore.CreateConnectionString("Repro963"))
                    .UseInternalServiceProvider(_serviceProvider);
...
SELECT `c`.`FirstName`, `c`.`LastName`
 ...
 WHERE (`c`.`FirstName` = :__firstName_0) AND (`c`.`LastName` = :__8__locals1_details_LastName_1)";
        ...
        private readonly XGFixture _fixture;

        public QueryBugsTest(XGFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public class MyContext3758 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXG(XGTestStore.CreateConnectionString("Repro3758"))
                    .UseInternalServiceProvider(_serviceProvider);
        ...
        public class MyContext3409 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder
                    .UseXG(XGTestStore.CreateConnectionString("Repro3409"))
                    .UseInternalServiceProvider(_serviceProvider);
        ...
        public class MyContext3101 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseXG(XGTestStore.CreateConnectionString("Repro3101"));
        ...
        {
            var connectionString = XGTestStore.CreateConnectionString(databaseName);
            XGTestStore.GetOrCreateShared(databaseName, () =>
                {
                    var optionsBuilder = new DbContextOptionsBuilder();
                    optionsBuilder.UseXG(connectionString);
