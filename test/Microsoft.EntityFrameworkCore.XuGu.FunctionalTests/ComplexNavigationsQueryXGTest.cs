...
namespace Microsoft.EntityFrameworkCore.XG.FunctionalTests
{
    ...
    public class ComplexNavigationsQueryXGTest : ComplexNavigationsQueryTestBase<XGTestStore, ComplexNavigationsQueryXGFixture>
    {
        public ComplexNavigationsQueryXGTest(
            ComplexNavigationsQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
