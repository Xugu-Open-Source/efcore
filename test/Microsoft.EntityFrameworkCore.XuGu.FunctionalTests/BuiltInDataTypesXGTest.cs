...
{
    public class BuiltInDataTypesXGTest : BuiltInDataTypesTestBase<BuiltInDataTypesXGFixture>
    {
        public BuiltInDataTypesXGTest(BuiltInDataTypesXGFixture fixture)
            : base(fixture)
        {
        }
...
//                parameters);
        ...
        private static void AssertMappedDataTypes(MappedDataTypes entity, int id)
        {
            ...
            Assert.Equal(new DateTime(2018, 1, 2, 13, 11, 12), entity.Smalldatetime);
