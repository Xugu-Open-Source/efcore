...
{
    public class XGValueGenerationScenariosTest
    {
        // Positive cases
        ...
        public class SequenceHiLo : TestBase<SequenceHiLo.BlogContext>
        {
            ...
            public class BlogContext : ContextBase
            {
                protected override void OnModelCreating(ModelBuilder modelBuilder)
                    => modelBuilder.ForXGUseSequenceHiLo();
            }
        }
        ...
        public abstract class ContextBase : DbContext
        {
            ...
            {
                var name = GetType().FullName.Substring((GetType().Namespace + nameof(XGValueGenerationScenariosTest)).Length + 2);
                optionsBuilder.UseXG(XGTestStore.CreateConnectionString(name));
            }
        }
