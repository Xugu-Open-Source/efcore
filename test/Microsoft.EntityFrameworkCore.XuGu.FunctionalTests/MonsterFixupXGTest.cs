...
{
    public class MonsterFixupXGTest : MonsterFixupTestBase
    {
        ...
        protected override DbContextOptions CreateOptions(string databaseName)
        {
            ...
            optionsBuilder.UseXG(CreateConnectionString(databaseName));
        ...
        public override void OnModelCreating<TMessage, TProductPhoto, TProductReview>(ModelBuilder builder)
        {
            ...
            builder.Entity<TMessage>().Property(e => e.MessageId).UseXGIdentityColumn();
            builder.Entity<TProductPhoto>().Property(e => e.PhotoId).UseXGIdentityColumn();
            builder.Entity<TProductReview>().Property(e => e.ReviewId).UseXGIdentityColumn();
        }
    }
}
