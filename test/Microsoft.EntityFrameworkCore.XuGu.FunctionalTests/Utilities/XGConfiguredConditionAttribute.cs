...
namespace Microsoft.EntityFrameworkCore.XG.FunctionalTests.Utilities
{
    ...
    public class XGConfiguredConditionAttribute : Attribute, ITestCondition
    {
        private static readonly string _dataSource = new SqlConnectionStringBuilder(XGTestStore.CreateConnectionString("sample")).DataSource;
