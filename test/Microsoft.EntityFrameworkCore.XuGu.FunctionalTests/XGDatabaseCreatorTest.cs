...
{
    public class XGDatabaseCreatorTest
    {
        [Fact]
        ...
        private static IServiceProvider CreateContextServices(XGTestStore testStore)
            => ((IInfrastructure<IServiceProvider>)new BloggingContext(
                new DbContextOptionsBuilder()
                    .UseXG(testStore.ConnectionString)
                    .UseInternalServiceProvider(new ServiceCollection()
                        .AddEntityFrameworkXG()
                        .AddScoped<XGDatabaseCreator, TestDatabaseCreator>().BuildServiceProvider()).Options))
                .Instance;

        private static IRelationalDatabaseCreator GetDatabaseCreator(XGTestStore testStore)
        ...
        public class TestDatabaseCreator : XGDatabaseCreator
        {
            public TestDatabaseCreator(
                Storage.Internal.XGConnection connection,
