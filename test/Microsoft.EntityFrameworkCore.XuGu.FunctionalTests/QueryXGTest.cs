...
namespace Microsoft.EntityFrameworkCore.XG.FunctionalTests
{
    ...
    public class QueryXGTest : QueryTestBase<NorthwindQueryXGFixture>
    {
        public QueryXGTest(NorthwindQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
 ...
 FROM (
    SELECT DISTINCT `c`.`City`
     FROM `Customers` `c`
        ...
        [Fact]
        [XGCondition(XGCondition.SupportsOffset)]
