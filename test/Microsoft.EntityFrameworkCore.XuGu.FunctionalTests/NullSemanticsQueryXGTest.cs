...
{
	public class NullSemanticsQueryXGTest : NullSemanticsQueryTestBase<XGTestStore, NullSemanticsQueryXGFixture>
    {
		public NullSemanticsQueryXGTest(NullSemanticsQueryXGFixture fixture)
            : base(fixture)
        {
        }
