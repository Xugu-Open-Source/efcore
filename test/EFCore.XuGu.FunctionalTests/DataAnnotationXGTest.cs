...
{
    public class DataAnnotationXGTest : DataAnnotationTestBase<DataAnnotationXGTest.DataAnnotationXGFixture>
    {
...
WHERE ROW_COUNT() = 1 AND `UniqueNo` = LAST_INSERT_ID();");
        ...
        public class DataAnnotationXGFixture : DataAnnotationFixtureBase
        {
