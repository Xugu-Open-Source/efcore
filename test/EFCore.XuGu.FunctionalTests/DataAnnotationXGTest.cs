...
{
    public class DataAnnotationXGTest : DataAnnotationRelationalTestBase<DataAnnotationXGTest.DataAnnotationXGFixture>
    {
        // ReSharper disable once UnusedParameter.Local
        public DataAnnotationXGTest(DataAnnotationXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE ROW_COUNT() = 1 AND `Unique_No` = LAST_INSERT_ID();");
        ...
        public class DataAnnotationXGFixture : DataAnnotationRelationalFixtureBase
        {
