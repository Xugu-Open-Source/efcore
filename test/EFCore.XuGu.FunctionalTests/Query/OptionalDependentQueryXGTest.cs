...
internal class OptionalDependentQueryXGTest : OptionalDependentQueryTestBase<OptionalDependentQueryXGFixture>
{
    public OptionalDependentQueryXGTest(OptionalDependentQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
