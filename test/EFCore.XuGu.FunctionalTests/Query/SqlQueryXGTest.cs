...
public class SqlQueryXGTest : SqlQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
{
    public SqlQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    {
        // Base implementation sends DateTime with Kind=Unspecified in a SQL query, but XG rejects it because timestamptz
