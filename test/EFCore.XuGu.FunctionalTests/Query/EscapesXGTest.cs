...
{
    public class EscapesXGTest : EscapesXGTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        private readonly ITestOutputHelper _output;

        public EscapesXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper) : base(fixture)
        {
