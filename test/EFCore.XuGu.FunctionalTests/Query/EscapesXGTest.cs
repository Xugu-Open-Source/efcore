...
{
    public class EscapesXGTest : EscapesXGTestBase<EscapesXGTest.EscapesXGFixture>
    {
        public EscapesXGTest(EscapesXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
""");
        ...
        public class EscapesXGFixture : EscapesXGFixtureBase
        {
