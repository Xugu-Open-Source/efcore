...
public class TPCManyToManyQueryXGTest : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQueryXGFixture>
{
    public TPCManyToManyQueryXGTest(TPCManyToManyQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
