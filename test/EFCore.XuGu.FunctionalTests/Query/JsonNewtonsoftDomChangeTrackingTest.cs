...
using Microsoft.EntityFrameworkCore.XuGu.Json.Newtonsoft.Infrastructure.Internal;
    ...
    public class JsonNewtonsoftDomChangeTrackingTest : IClassFixture<JsonNewtonsoftDomChangeTrackingTest.JsonMicrosoftDomChangeTrackingFixture>
    {
        ...
        public class JsonMicrosoftDomChangeTrackingContext : PoolableDbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            {
                ...
                {
                    ((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension((XGJsonNewtonsoftOptionsExtension)
                        (optionsBuilder.Options.FindExtension<XGJsonNewtonsoftOptionsExtension>() ??
                         new XGJsonNewtonsoftOptionsExtension())
