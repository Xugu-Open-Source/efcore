...
{
    public class InheritanceXGTest : InheritanceRelationalTestBase<InheritanceXGFixture>
    {
        public InheritanceXGTest(InheritanceXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
