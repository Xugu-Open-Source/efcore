...
using Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.TestUtilities.DebugServices;
using Xunit;
...
namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.Query
{
    ...
    public class NorthwindSplitIncludeNoTrackingQueryXGTest : NorthwindSplitIncludeNoTrackingQueryTestBase<NorthwindSplitIncludeNoTrackingQueryXGTest.NorthwindSplitIncludeNoTrackingQueryXGFixture>
    {
        public NorthwindSplitIncludeNoTrackingQueryXGTest(NorthwindSplitIncludeNoTrackingQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class NorthwindSplitIncludeNoTrackingQueryXGFixture : NorthwindQueryXGFixture<NoopModelCustomizer>
        {
            // We used our `DebugRelationalCommandBuilderFactory` implementation to track down a
            // bug in Oracle's XuGu implementation, related to `SELECT ... ORDER BY (SELECT 1)`.
