...
{
    public class NorthwindSplitIncludeNoTrackingQueryXGTest : NorthwindSplitIncludeNoTrackingQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        public NorthwindSplitIncludeNoTrackingQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
