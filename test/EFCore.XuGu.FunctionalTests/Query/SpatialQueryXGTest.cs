...
namespace EntityFrameworkCore.XuGu.FunctionalTests.Query
{
    public class SpatialQueryXGTest : SpatialQueryRelationalTestBase<SpatialQueryXGFixture>
    {
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.SpatialFunctionAdditions), Skip = "XG is unable to work with different SRIDs.")]
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.SpatialSupportFunctionAdditions))] // Actually supported since XG 5.7.5 (not 5.7.6)
        public override Task ConvexHull(bool async)
            => base.ConvexHull(async);

        #region Not supported by XG and MariaDB
