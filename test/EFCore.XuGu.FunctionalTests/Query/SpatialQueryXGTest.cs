...
{
    public class SpatialQueryXGTest : SpatialQueryRelationalTestBase<SpatialQueryXGFixture>
    {
        public SpatialQueryXGTest(SpatialQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.SpatialFunctionAdditions), Skip = "XuGu is unable to work with different SRIDs.")]
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.SpatialSupportFunctionAdditions))] // Actually supported since XuGu 5.7.5 (not 5.7.6)
...
""");
        ...
        #region Not supported by XuGu and MariaDB
