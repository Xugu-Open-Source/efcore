...
{
    public class NorthwindStringIncludeQueryXGTest : NorthwindStringIncludeQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public NorthwindStringIncludeQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
            ClearLog();
        }
