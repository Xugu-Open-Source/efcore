...
{
    public class TPTGearsOfWarQueryXGTest : TPTGearsOfWarQueryRelationalTestBase<TPTGearsOfWarQueryXGFixture>
    {
#pragma warning disable IDE0060 // Remove unused parameter
        public TPTGearsOfWarQueryXGTest(TPTGearsOfWarQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        {
            var dto = GearsOfWarQueryXGFixture.GetExpectedValue(new DateTimeOffset(599898024001234567, new TimeSpan(1, 30, 0)));
        ...
        {
            var dateTimeOffset = GearsOfWarQueryXGFixture.GetExpectedValue(new DateTimeOffset(599898024001234567, new TimeSpan(1, 30, 0)));
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.OuterApply), Skip = "https://bugs.XG.com/bug.php?id=96946")]
        ...
        [SupportedServerVersionCondition("8.0.18-XG", Skip = "TODO: Pinpoint exact version number! Referencing outer column from WHERE subquery does not work in previous versions. Inverse of #573")]
        ...
        [ConditionalTheory( /*Skip = "https://github.com/XG-net/XuguClient/pull/707"*/)]
        ...
        [SupportedServerVersionCondition("8.0.22-XG")]
