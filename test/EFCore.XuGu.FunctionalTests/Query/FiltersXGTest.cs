...
{
    public class FiltersXGTest : FiltersTestBase<NorthwindQueryXGFixture<NorthwindFiltersCustomizer>>
    {
        public FiltersXGTest(NorthwindQueryXGFixture<NorthwindFiltersCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
