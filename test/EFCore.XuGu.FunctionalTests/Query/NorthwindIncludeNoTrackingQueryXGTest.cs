...
{
    public class NorthwindIncludeNoTrackingQueryXGTest : NorthwindIncludeNoTrackingQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public NorthwindIncludeNoTrackingQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture)
            : base(fixture)
        {
            ClearLog();
        }
