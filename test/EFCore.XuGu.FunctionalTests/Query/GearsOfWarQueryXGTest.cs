...
{
    public partial class GearsOfWarQueryXGTest : GearsOfWarQueryRelationalTestBase<GearsOfWarQueryXGFixture>
    {
        public GearsOfWarQueryXGTest(GearsOfWarQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
