...
public class DateOnlyQueryXGTest : DateOnlyQueryXGTestBase<DateOnlyQueryXGTest.DateOnlyQueryXGFixture>
{
    public DateOnlyQueryXGTest(
        DateOnlyQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
WHERE TIMESTAMPDIFF(DAY, CURDATE(), CAST(`i`.`BestServedBefore` AS datetime(6))) < 30");
    ...
    public class DateOnlyQueryXGFixture : DateOnlyQueryXGFixtureBase
    {
        protected override ITestStoreFactory TestStoreFactory => XGTestStoreFactory.Instance;
    }
}

public abstract class DateOnlyQueryXGTestBase<TFixture> : QueryTestBase<TFixture>
    where TFixture : DateOnlyQueryXGTestBase<TFixture>.DateOnlyQueryXGFixtureBase, new()
{
    protected DateOnlyQueryXGTestBase(TFixture fixture)
        : base(fixture)
    {
    ...
    public abstract class DateOnlyQueryXGFixtureBase : SharedStoreFixtureBase<PoolableDbContext>, IQueryFixtureBase, ITestSqlLoggerFactory
    {
