...
public class PrimitiveCollectionsQueryXGTest : PrimitiveCollectionsQueryRelationalTestBase<
    PrimitiveCollectionsQueryXGTest.PrimitiveCollectionsQueryXGFixture>
{
    public PrimitiveCollectionsQueryXGTest(PrimitiveCollectionsQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
        ...
        {
            var exception = await Assert.ThrowsAsync<Exception>(() => base.Inline_collection_of_nullable_value_type_Min(async));
...
""");
        ...
        {
            var exception = await Assert.ThrowsAsync<Exception>(() => base.Inline_collection_of_nullable_value_type_Max(async));
            Assert.True(exception.Message is "Field reference 'p.Int' can't be used in table value constructor"
                                          or "Unknown table 'p' in order clause");
        }
    }
...
""");
        ...
        {
            var exception = await Assert.ThrowsAsync<Exception>(() => base.Inline_collection_of_nullable_value_type_with_null_Min(async));
...
""");
        ...
        {
            var exception = await Assert.ThrowsAsync<Exception>(() => base.Inline_collection_of_nullable_value_type_with_null_Max(async));
            Assert.True(exception.Message is "Field reference 'p.NullableInt' can't be used in table value constructor"
                                          or "Unknown table 'p' in order clause");
        }
    }
...
""");
    ...
    public class PrimitiveCollectionsQueryXGFixture : PrimitiveCollectionsQueryFixtureBase, ITestSqlLoggerFactory
    {
