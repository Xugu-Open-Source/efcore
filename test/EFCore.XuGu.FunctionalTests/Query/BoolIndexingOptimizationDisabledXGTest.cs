...
{
    public class BoolIndexingOptimizationDisabledXGTest : QueryTestBase<BoolIndexingOptimizationDisabledXGTest.BoolIndexingOptimizationDisabledXGFixture>
    {
        public BoolIndexingOptimizationDisabledXGTest(BoolIndexingOptimizationDisabledXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE `w`.`IsAutomatic`"),
        ...
        public class BoolIndexingOptimizationDisabledXGFixture : GearsOfWarQueryXGFixture
        {
