...
{
    public class AsyncGroupByQueryXGTest : AsyncGroupByQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        // ReSharper disable once UnusedParameter.Local
        public AsyncGroupByQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        [ConditionalFact]
        public override async Task GroupBy_Select_sum_over_unmapped_property()
        {
        ...
        [ConditionalFact]
        public override async Task Select_GroupBy_All()
        {
            using (var context = CreateContext())
            {
                Assert.False(
        ...
        [ConditionalFact]
        public override async Task GroupBy_anonymous_key_without_aggregate()
        {
            using (var context = CreateContext())
            {
        ...
        [ConditionalFact]
        public override async Task Select_GroupBy()
        {
            using (var context = CreateContext())
            {
        ...
        [ConditionalFact]
        public override async Task Select_GroupBy_SelectMany()
        {
            using (var context = CreateContext())
            {
                var actual = (await context.Set<Order>().Select(
        ...
        public override async Task Double_GroupBy_with_aggregate()
        {
            using (var context = CreateContext())
            {
                var actual = await context.Set<Order>()
