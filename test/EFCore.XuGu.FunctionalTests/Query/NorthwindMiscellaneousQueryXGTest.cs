...
{
    public partial class NorthwindMiscellaneousQueryXGTest : NorthwindMiscellaneousQueryRelationalTestBase<
        NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        public NorthwindMiscellaneousQueryXGTest(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Lifting_when_subquery_nested_order_by_simple(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Lifting_when_subquery_nested_order_by_anonymous(bool async)
            => AssertQuery(
                async,
                ss => from c1_Orders in ss.Set<Order>()
                      join _c1 in
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_with_entity_equality_local_on_both_sources(bool async)
        {
            var local = new Customer { CustomerID = "ANATR" };
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Entity_equality_through_DTO_projection(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Skip(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Skip_no_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_Skip(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Distinct_Skip(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_Customers_Orders_Skip_Take(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_Customers_Orders_Skip_Take_followed_by_constant_projection(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_Customers_Orders_Projection_With_String_Concat_Skip_Take(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_Customers_Orders_Orders_Skip_Take_Same_Properties(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Skip_Take_Any(bool async)
            => AssertAny(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.ContactName).Skip(5).Take(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Skip_Take_All(bool async)
            => AssertAll(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_All(bool async)
            => AssertAll(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_Skip_Distinct(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Distinct_Take_Count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_Distinct_Count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_Where_Distinct_Count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_Take_Count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_OrderBy_Count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested_negated(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested_negated2(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested_negated3(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => ss.Set<Order>().Any(o => o.CustomerID.StartsWith("A"))),
                entryCount: 91);
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested2(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_nested3(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Any_with_multiple_conditions_still_uses_exists(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task All_top_level_column(bool async)
            => AssertAll(
                async,
                ss => ss.Set<Customer>(),
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_with_single(bool async)
            => AssertSingle(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_with_single_select_many(bool async)
            => AssertSingle(
                async,
                ss => (from c in ss.Set<Customer>()
                       from o in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many_or(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many_or2(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many_or3(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many_or4(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many_or_with_parameter(bool async)
        {
            var london = "London";
            var lisboa = "Lisboa";
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_subquery_anon(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_subquery_anon_nested(bool async)
            => AssertQuery(
                async,
                ss =>
                    from t in (
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_DTO_constructor_distinct_with_navigation_translated_to_server(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Order>()
                    .Where(o => o.OrderID < 10300)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_nested_collection_count_using_DTO(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_DTO_with_member_init_distinct_in_subquery_translated_to_server(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_DTO_with_member_init_distinct_in_subquery_used_in_projection_translated_to_server(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_correlated_subquery_filtered(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_subquery_on_bool(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_subquery_on_collection(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_query_composition(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_subquery_recursive_trivial(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_simple1(bool async)
            => AssertQuery(
                async,
                ss =>
                    from e in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_simple_subquery(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_simple2(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_entity_deep(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
                      from e2 in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_projection1(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
                      from e2 in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_projection2(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
                      from e2 in ss.Set<Employee>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_cartesian_product_with_ordering(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_Where_Count(bool async)
            => AssertCount(
                async,
                ss => (from c in ss.Set<Customer>()
                       join o in ss.Set<Order>() on c.CustomerID equals o.CustomerID
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_Join_Any(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Multiple_joins_Where_Order_Any(bool async)
            => AssertAny(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_OrderBy_Count(bool async)
            => AssertCount(
                async,
                ss => from c in ss.Set<Customer>()
                      join o in ss.Set<Order>() on c.CustomerID equals o.CustomerID
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_join_select(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_orderby_join_select(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_join_orderby_join_select(bool async)
            => AssertQuery(
                async,
                ss => from c in ss.Set<Customer>()
                      where c.CustomerID != "ALFKI"
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_select_many(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Where_orderby_select_many(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Default_if_empty_top_level(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_with_default_if_empty_on_both_sources(bool async)
            => AssertQuery(
                async,
                ss => (from e in ss.Set<Employee>().Where(c => c.EmployeeID == NonExistentID).DefaultIfEmpty()
                       select e).Join(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Default_if_empty_top_level_followed_by_projecting_constant(bool async)
            => AssertQuery(
                async,
                ss => from e in ss.Set<Employee>().Where(c => c.EmployeeID == NonExistentID).DefaultIfEmpty()
                      select "Foo");
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Default_if_empty_top_level_positive(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Default_if_empty_top_level_projection(bool async)
            => AssertQueryScalar(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_customer_orders(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_Count(bool async)
            => AssertCount(
                async,
                ss => from c in ss.Set<Customer>()
                      from o in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_LongCount(bool async)
            => AssertLongCount(
                async,
                ss => from c in ss.Set<Customer>()
                      from o in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_OrderBy_ThenBy_Any(bool async)
            => AssertAny(
                async,
                ss => from c in ss.Set<Customer>()
                      from o in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_true(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_integer(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_parameter(bool async)
        {
            var param = 5;
            return AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_shadow(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_multiple(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_SelectMany(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>().OrderBy(c => c.CustomerID)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Let_any_subquery_anonymous(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_arithmetic(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_condition_comparison(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_ternary_conditions(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_Joined(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_Joined_DefaultIfEmpty(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SelectMany_Joined_DefaultIfEmpty2(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_many_cross_join_same_collection(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_null_coalesce_operator(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_null_coalesce_operator(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_conditional_operator(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>()
...
#pragma warning restore IDE0029 // Use coalesce expression
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_comparison_operator(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Take_skip_null_coalesce_operator(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_null_coalesce_operator(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_skip_null_coalesce_operator(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_skip_null_coalesce_operator2(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_skip_null_coalesce_operator3(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Selected_column_can_coalesce(bool async)
            => AssertQuery(
                async,
                ss => (from c in ss.Set<Customer>()
                       orderby c.Region ?? "ZZ"
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Concat_string_int(bool isAsync)
            => AssertQuery(
                isAsync,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Concat_int_string(bool isAsync)
            => AssertQuery(
                isAsync,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Concat_parameter_string_int(bool isAsync)
        {
            var parameter = "-";
            return AssertQuery(
                isAsync,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Concat_constant_string_int(bool isAsync)
            => AssertQuery(
                isAsync,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task String_concat_with_navigation1(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task String_concat_with_navigation2(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_bitwise_or(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_bitwise_or_multiple(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.CustomerID)
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_bitwise_and_or(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.CustomerID)
                    .Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_bitwise_or_with_logical_or(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.CustomerID).Select(
                    c => new { c.CustomerID, Value = c.CustomerID == "ALFKI" | c.CustomerID == "ANATR" || c.CustomerID == "ANTON" }));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_bitwise_and_with_logical_and(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.CustomerID).Select(
                    c => new { c.CustomerID, Value = c.CustomerID == "ALFKI" & c.CustomerID == "ANATR" && c.CustomerID == "ANTON" }));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Handle_materialization_properly_when_more_than_two_query_sources_are_involved(bool async)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Parameter_extraction_can_throw_exception_from_user_code(bool async)
        {
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Parameter_extraction_can_throw_exception_from_user_code_2(bool async)
        {
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DefaultIfEmpty_without_group_join(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DefaultIfEmpty_in_subquery(bool async)
            => AssertQuery(
                async,
                ss =>
                    (from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_skip_take(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_skip_skip_take(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.ContactTitle)
                    .ThenBy(c => c.ContactName)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_skip_take_take(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.ContactTitle)
                    .ThenBy(c => c.ContactName)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_skip_take_skip_take_skip(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.ContactTitle)
                    .ThenBy(c => c.ContactName)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_coalesce_skip_take_distinct_take(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Product>().OrderBy(p => p.UnitPrice ?? 0)
                    .Skip(5)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_skip_take_distinct_orderby_take(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.ContactTitle)
                    .ThenBy(c => c.ContactName)
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task No_orderby_added_for_fully_translated_manually_constructed_LOJ(bool async)
            => AssertQuery(
                async,
                ss => from e1 in ss.Set<Employee>()
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Contains_with_subquery_involving_join_binds_to_correct_table(bool async)
            => AssertQuery(
                async,
                ss =>
                    ss.Set<Order>().Where(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Anonymous_member_distinct_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Anonymous_member_distinct_result(bool async)
            => AssertSingleResult(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Anonymous_complex_distinct_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Anonymous_complex_distinct_result(bool async)
            => AssertSingleResult(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Anonymous_complex_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DTO_member_distinct_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DTO_member_distinct_result(bool async)
            => AssertSingleResult(
                async,
                syncQuery: ss => ss.Set<Customer>().Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DTO_complex_distinct_orderby(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>().Select(c => new DTO<string> { Property = c.CustomerID + c.City }).Distinct()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DTO_complex_distinct_result(bool async)
            => AssertSingleResult(
                async,
                syncQuery: ss => ss.Set<Customer>().Select(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task DTO_complex_orderby(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Include_with_orderby_skip_preserves_ordering(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Complex_query_with_repeated_query_model_compiles_correctly(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Complex_query_with_repeated_nested_query_model_compiles_correctly(bool async)
            => AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Where(outer => outer.CustomerID == "ALFKI")
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_average(bool async)
            => AssertAverage(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_orderBy_take_count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_long_count(bool async)
            => AssertLongCount(
                async,
                ss => ss.Set<Customer>().Take(7));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_orderBy_take_long_count(bool async)
            => AssertLongCount(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.Country).Take(7));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_max(bool async)
            => AssertMax(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Take(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_min(bool async)
            => AssertMin(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Take(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_take_sum(bool async)
            => AssertSum(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Take(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_average(bool async)
            => AssertAverage(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_orderBy_skip_count(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_long_count(bool async)
            => AssertLongCount(
                async,
                ss => ss.Set<Customer>().Skip(7));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_orderBy_skip_long_count(bool async)
            => AssertLongCount(
                async,
                ss => ss.Set<Customer>().OrderBy(c => c.Country).Skip(7));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_max(bool async)
            => AssertMax(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Skip(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_min(bool async)
            => AssertMin(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Skip(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_skip_sum(bool async)
            => AssertSum(
                async,
                ss => ss.Set<Order>().OrderBy(o => o.OrderID).Select(o => o.OrderID).Skip(10));
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_distinct_average(bool async)
            => AssertAverage(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_distinct_max(bool async)
            => AssertMax(
                async,
                ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_distinct_min(bool async)
            => AssertMin(
                async,
                ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Select_distinct_sum(bool async)
            => AssertSum(
                async,
                ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_entities_using_Equals(bool async)
            => AssertQuery(
                async,
                ss => from c1 in ss.Set<Customer>()
                      from c2 in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_different_entity_types_using_Equals(bool async)
            => AssertQuery(
                async,
                ss => from c in ss.Set<Customer>()
                      from o in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_navigations_using_Equals(bool async)
            => AssertQuery(
                async,
                ss =>
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_navigations_using_static_Equals(bool async)
            => AssertQuery(
                async,
                ss =>
                    from o1 in ss.Set<Order>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_non_matching_entities_using_Equals(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_non_matching_collection_navigations_using_Equals(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Comparing_collection_navigation_to_null_complex(bool async)
            => AssertQuery(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Compare_two_collection_navigations_with_different_query_sources(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c1 in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Compare_two_collection_navigations_using_equals(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c1 in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Compare_two_collection_navigations_with_different_property_chains(bool async)
            => AssertQuery(
                async,
                ss =>
                    from c in ss.Set<Customer>()
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Join_take_count_works(bool async)
            => AssertCount(
                async,
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_empty_list_contains(bool async)
        {
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task OrderBy_empty_list_does_not_contains(bool async)
        {
            var list = new List<string>();
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Manual_expression_tree_typed_null_equality(bool async)
        {
            using var context = CreateContext();
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Let_subquery_with_multiple_occurrences(bool async)
            => AssertQuery(
                async,
                ss => from o in ss.Set<Order>()
                      let details =
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        private static string StaticMethod(NorthwindMiscellaneousQueryTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>> containingClass, Customer c)
            => c.City;
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task Checked_context_with_case_to_same_nullable_type_does_not_fail(bool isAsync)
            => AssertMax(
                isAsync,
                ss => ss.Set<OrderDetail>(),
                ss => ss.Set<OrderDetail>(),
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task String_include_on_incorrect_property_throws(bool async)
            => Assert.ThrowsAsync<InvalidOperationException>(
                async () => await AssertQuery(async, ss => ss.Set<Customer>().Include("OrderDetails")));

        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task EF_Property_include_on_incorrect_property_throws(bool async)
            => Assert.ThrowsAsync<InvalidOperationException>(
        ...
        [ConditionalTheory]
        [MemberData(nameof(IsAsyncData))]
        public override Task SkipWhile_throws_meaningful_exception(bool async)
            => AssertTranslationFailed(
                () => AssertQuery(
                    async,
        ...
        protected override async Task Single_Predicate_Cancellation_test(CancellationToken cancellationToken)
        {
