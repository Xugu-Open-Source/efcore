...
namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.Query
{
    ...
    public class SpatialGeographyQueryXGTest : QueryTestBase<SpatialGeographyQueryXGTest.SpatialGeographyQueryXGFixture>
    {
        public SpatialGeographyQueryXGTest(SpatialGeographyQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public class SpatialGeographyQueryXGFixture : SharedStoreFixtureBase<SpatialGeographyContext>, IQueryFixtureBase, ITestSqlLoggerFactory
        {
