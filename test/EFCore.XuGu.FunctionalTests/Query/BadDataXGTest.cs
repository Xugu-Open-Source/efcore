...
{
    public class BadDataXGTest : IClassFixture<BadDataXGTest.BadDataXGFixture>
    {
        public BadDataXGTest(BadDataXGFixture fixture) => Fixture = fixture;

        public BadDataXGFixture Fixture { get; }
        ...
        private class FakeConnection : IRelationalConnection
        {
            ...
            public Task<IDbContextTransaction> BeginTransactionAsync(System.Data.IsolationLevel isolationLevel, CancellationToken cancellationToken = default(CancellationToken)) => throw new NotImplementedException();
            public IDbContextTransaction UseTransaction(DbTransaction transaction) => throw new NotImplementedException();
            public void Dispose() {}
        }

        public class BadDataXGFixture : NorthwindQueryXGFixture<NoopModelCustomizer>
        {
