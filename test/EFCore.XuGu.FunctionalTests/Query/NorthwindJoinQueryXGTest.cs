...
{
    public class NorthwindJoinQueryXGTest : NorthwindJoinQueryRelationalTestBase<NorthwindQueryXGFixture<NoopModelCustomizer>>
    {
        public NorthwindJoinQueryXGTest(NorthwindQueryXGFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
            ClearLog();
        ...
        /// <summary>
        /// Needs explicit ordering of views to work consistently with XG.
        /// But since CustomerViewModel is private, we can't even override the test case properly.
        /// </summary>
        [ConditionalTheory(Skip = "Needs explicit ordering of views to work consistently with XG.")]
