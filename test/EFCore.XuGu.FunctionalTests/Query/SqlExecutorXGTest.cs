...
{
    public class SqlExecutorXGTest : SqlExecutorTestBase<NorthwindQueryXGFixture<SqlExecutorModelCustomizer>>
    {
        public SqlExecutorXGTest(NorthwindQueryXGFixture<SqlExecutorModelCustomizer> fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
""");
        ...
        {
            // We have to reimplement the base method, because it uses double-quote delimiters, while XuGu uses ticks.
