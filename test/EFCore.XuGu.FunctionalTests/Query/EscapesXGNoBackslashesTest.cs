...
{
    public class EscapesXGNoBackslashesTest : EscapesXGTestBase<NorthwindQueryXGNoBackslashesFixture<NoopModelCustomizer>>
    {
        public EscapesXGNoBackslashesTest(NorthwindQueryXGNoBackslashesFixture<NoopModelCustomizer> fixture, ITestOutputHelper testOutputHelper) : base(fixture)
        {
