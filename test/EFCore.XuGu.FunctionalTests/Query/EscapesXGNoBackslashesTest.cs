...
{
    public class EscapesXGNoBackslashesTest : EscapesXGTestBase<EscapesXGNoBackslashesTest.EscapesXGNoBackslashesFixture>
    {
        public EscapesXGNoBackslashesTest(EscapesXGNoBackslashesFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE `a`.`Name` IN ('Back\slasher''s', 'John''s Chill Box')");
        ...
        public class EscapesXGNoBackslashesFixture : EscapesXGFixtureBase
        {
