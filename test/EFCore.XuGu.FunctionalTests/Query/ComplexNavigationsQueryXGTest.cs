...
{
    public class ComplexNavigationsQueryXGTest : ComplexNavigationsQueryRelationalTestBase<ComplexNavigationsQueryXGFixture>
    {
        ...
        public override async Task GroupJoin_client_method_in_OrderBy(bool async)
        {
            await AssertTranslationFailedWithDetails(
                ...
                CoreStrings.QueryUnableToTranslateMethod(
                    "Microsoft.EntityFrameworkCore.Query.ComplexNavigationsQueryTestBase<Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.Query.ComplexNavigationsQueryXGFixture>",
