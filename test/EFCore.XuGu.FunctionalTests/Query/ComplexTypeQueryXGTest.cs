...
public class ComplexTypeQueryXGTest : ComplexTypeQueryRelationalTestBase<
    ComplexTypeQueryXGTest.ComplexTypeQueryXGFixture>
{
    public ComplexTypeQueryXGTest(ComplexTypeQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class ComplexTypeQueryXGFixture : ComplexTypeQueryRelationalFixtureBase
    {
