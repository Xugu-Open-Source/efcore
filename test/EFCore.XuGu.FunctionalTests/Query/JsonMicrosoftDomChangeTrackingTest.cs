...
using EntityFrameworkCore.XuGu.Json.Microsoft.Extensions.Internal;
using EntityFrameworkCore.XuGu.Json.Microsoft.Infrastructure.Internal;
...
namespace EntityFrameworkCore.XuGu.FunctionalTests.Query
{
    ...
    public class JsonMicrosoftDomChangeTrackingTest : IClassFixture<JsonMicrosoftDomChangeTrackingTest.JsonMicrosoftDomChangeTrackingFixture>
    {
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.CompareDomSemantically);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.HashDomSemantially);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.HashDomSemantiallyOptimized);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        public class JsonMicrosoftDomChangeTrackingContext : PoolableDbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            {
                ...
                {
                    ((IDbContextOptionsBuilderInfrastructure)optionsBuilder).AddOrUpdateExtension((XGJsonMicrosoftOptionsExtension)
                        (optionsBuilder.Options.FindExtension<XGJsonMicrosoftOptionsExtension>() ??
