...
namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.Query
{
        ...
        where TFixture : JsonStringChangeTrackingTestBase<TFixture>.JsonStringChangeTrackingFixtureBase
    {
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.CompareRootPropertyOnly);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.None);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.None, true);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.CompareStringRootPropertyByEquals);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        {
            using var ctx = CreateContext(XGJsonChangeTrackingOptions.SnapshotCallsClone);
            var x = ctx.JsonEntities.Single(e => e.Id == 1);
        ...
        protected JsonStringChangeTrackingContext CreateContext(
            XGJsonChangeTrackingOptions? changeTrackingOptions = null,
            bool isGlobal = false)
    ...
    [
        {
            ...
            private void SetGlobalJsonChangeTrackingOptions(
                ...
                XGJsonChangeTrackingOptions jsonChangeTrackingOptions)
            {
                var xgJsonOptions = (XGJsonOptionsExtension) optionsBuilder.Options.Extensions.Last(e => e is XGJsonOptionsExtension);
                xgJsonOptions = xgJsonOptions.WithJsonChangeTrackingOptions(jsonChangeTrackingOptions);
                ...
                var addOrUpdateExtensionMethod = optionsBuilder.GetType()
                    ...
                    .MakeGenericMethod(xgJsonOptions.GetType());

                addOrUpdateExtensionMethod.Invoke(optionsBuilder, new object[] {xgJsonOptions});
            }
            ...
            {
                public XGJsonChangeTrackingOptions? ChangeTrackingOptions { get; set; }
        ...
        public class JsonStringChangeTrackingFixtureBase : ServiceProviderPerContextFixtureBase<JsonStringChangeTrackingContext>
        {
            ...
            public virtual DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder, XGJsonChangeTrackingOptions? changeTrackingOptions)
                => builder;
        }
