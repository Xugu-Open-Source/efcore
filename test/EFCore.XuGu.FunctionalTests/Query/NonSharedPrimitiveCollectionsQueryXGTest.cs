...
public class NonSharedPrimitiveCollectionsQueryXGTest : NonSharedPrimitiveCollectionsQueryRelationalTestBase
{
...
""");
    ...
    public override async Task Column_collection_inside_json_owned_entity()
    {
        ...
        Assert.Equal(XGStrings.Ef7CoreJsonMappingNotSupported, exception.Message);
    }
...
""");
    ...
    {
        new XGDbContextOptionsBuilder(optionsBuilder).TranslateParameterizedCollectionsToConstants();
    ...
    {
        new XGDbContextOptionsBuilder(optionsBuilder).TranslateParameterizedCollectionsToParameters();
