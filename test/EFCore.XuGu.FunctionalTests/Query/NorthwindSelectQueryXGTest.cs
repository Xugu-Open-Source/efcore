...
FROM `Orders` AS `o`");
        ...
        [SupportedServerVersionCondition(nameof(ServerVersionSupport.JsonTableImplementationUsingParameterAsSourceWithoutEngineCrash), Skip = "This test/query crashes XG 8 even with inlined parameters every single time. Could be related to LATERAL.")]
...
""");
        ...
        [ConditionalTheory(Skip = "Leads to a different result set in CI on Linux with XG 8.0.17. TODO: Needs investigation!")]
        ...
        [ConditionalTheory(Skip = "TODO: Seems to be a XG bug. Needs to be verified and reported, if not already.")]
