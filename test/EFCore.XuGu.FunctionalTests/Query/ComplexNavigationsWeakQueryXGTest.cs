...
{
    public class ComplexNavigationsWeakQueryXGTest : ComplexNavigationsWeakQueryRelationalTestBase<ComplexNavigationsWeakQueryXGFixture>
    {
        public ComplexNavigationsWeakQueryXGTest(ComplexNavigationsWeakQueryXGFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        [ConditionalTheory(Skip = "https://bugs.XG.com/bug.php?id=101276")]
