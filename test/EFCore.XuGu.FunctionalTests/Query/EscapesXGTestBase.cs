...
{
    public abstract class EscapesXGTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : EscapesXGTestBase<TFixture>.EscapesXGFixtureBase, new()
    {
        ...
        public abstract class EscapesXGFixtureBase : SharedStoreFixtureBase<MusicStoreContext>
        {
