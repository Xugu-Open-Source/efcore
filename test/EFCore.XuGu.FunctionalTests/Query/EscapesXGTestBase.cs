...
{
    public abstract class EscapesXGTestBase<TFixture> : IClassFixture<TFixture>, IDisposable where TFixture : NorthwindQueryXGFixture<NoopModelCustomizer>
    {
        private readonly NorthwindContext _context;
        protected EscapesXGTestBase(TFixture fixture)
        {
            Fixture = fixture;
        ...
        {
            _context.Database.ExecuteSqlCommand("SET SESSION sql_mode = @p0", new XGParameters("@p0", modes) );
        }
