...
{
    public class XGJsonMicrosoftTypeMappingTest
    {
        #region Json
        ...
        private static readonly XGTypeMappingSource Mapper = new XGTypeMappingSource(
            new TypeMappingSourceDependencies(
                new ValueConverterSelector(new ValueConverterSelectorDependencies()),
                Array.Empty<ITypeMappingSourcePlugin>()),
            new RelationalTypeMappingSourceDependencies(
                new [] {new XGJsonMicrosoftTypeMappingSourcePlugin(new XGOptions())}),
            new XGOptions()
        );
