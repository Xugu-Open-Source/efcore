...
namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests
{
    ...
    public class MigrationsInfrastructureXGTest : MigrationsInfrastructureTestBase<MigrationsInfrastructureXGTest.MigrationsInfrastructureXGFixture>
    {
        public MigrationsInfrastructureXGTest(MigrationsInfrastructureXGFixture fixture)
            : base(fixture)
        {
        }
...
""",
        ...
        public override void Can_get_active_provider()
        {
            ...
            Assert.Equal("Microsoft.EntityFrameworkCore.XuGu", ActiveProvider);
        }
        ...
        protected override Task ExecuteSqlAsync(string value)
            => ((XGTestStore)Fixture.TestStore).ExecuteNonQueryAsync(value);
        ...
        public class MigrationsInfrastructureXGFixture : MigrationsInfrastructureFixtureBase
        {
