...
";
 ...
 WHERE `TABLE_SCHEMA` = 'builtindatatypes'";
        ...
        public class BuiltInDataTypesXGFixture : BuiltInDataTypesFixtureBase
        {
            ...
            public TestSqlLoggerFactory TestSqlLoggerFactory => (TestSqlLoggerFactory)ListLoggerFactory;//new TestSqlLoggerFactory();
        ...
        protected class MappedNullableDataTypes
        {
            ...
            [Column(TypeName = "decimal(20,0)")]
            public Decimal? UlongAsDecimal200 { get; set; }
