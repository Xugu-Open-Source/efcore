...
public class NorthwindBulkUpdatesXGTest : NorthwindBulkUpdatesRelationalTestBase<NorthwindBulkUpdatesXGFixture<NoopModelCustomizer>>
{
    public NorthwindBulkUpdatesXGTest(
        NorthwindBulkUpdatesXGFixture<NoopModelCustomizer> fixture,
...
""");
    ...
    {
        if (AppConfig.ServerVersion.Type == ServerType.XG)
        {
            // Not supported by XuGu:
