...
public class TPHFiltersInheritanceBulkUpdatesXGTest : FiltersInheritanceBulkUpdatesTestBase<
    TPHFiltersInheritanceBulkUpdatesXGFixture>
{
    public TPHFiltersInheritanceBulkUpdatesXGTest(TPHFiltersInheritanceBulkUpdatesXGFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
