...
public class NonSharedModelBulkUpdatesXGTest : NonSharedModelBulkUpdatesRelationalTestBase
{
...
""");
    ...
    public override Task Delete_with_owned_collection_and_non_natively_translatable_query(bool async)
        => Assert.ThrowsAsync<Exception>(() =>base.Delete_with_owned_collection_and_non_natively_translatable_query(async));
