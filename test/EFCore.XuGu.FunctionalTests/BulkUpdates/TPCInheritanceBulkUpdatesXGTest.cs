...
public class TPCInheritanceBulkUpdatesXGTest : TPCInheritanceBulkUpdatesTestBase<TPCInheritanceBulkUpdatesXGFixture>
{
    public TPCInheritanceBulkUpdatesXGTest(
        TPCInheritanceBulkUpdatesXGFixture fixture,
