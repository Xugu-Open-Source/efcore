...
public class FiltersInheritanceBulkUpdatesXGTest : FiltersInheritanceBulkUpdatesTestBase<
    FiltersInheritanceBulkUpdatesXGFixture>
{
    public FiltersInheritanceBulkUpdatesXGTest(FiltersInheritanceBulkUpdatesXGFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
