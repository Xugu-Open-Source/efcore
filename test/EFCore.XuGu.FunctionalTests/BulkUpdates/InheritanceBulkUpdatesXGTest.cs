...
public class InheritanceBulkUpdatesXGTest : InheritanceBulkUpdatesTestBase<InheritanceBulkUpdatesXGFixture>
{
    public InheritanceBulkUpdatesXGTest(InheritanceBulkUpdatesXGFixture fixture)
        : base(fixture)
    {
        ClearLog();
    }
