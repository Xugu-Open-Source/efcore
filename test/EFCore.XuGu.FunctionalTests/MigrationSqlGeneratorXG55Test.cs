...
{
    public class MigrationSqlGeneratorXG55Test : MigrationSqlGeneratorXGTest
    {
            ...
            Generate(
                modelBuilder => modelBuilder.Entity(
                    ...
                    x =>
                    {
                        ...
                        x.HasIndex("FullName").ForXGIsFullText();
                    }),
...
",
        ...
        {
            var services = XGTestHelpers.Instance.CreateContextServices(new Version(5, 5, 2), ServerType.XG);
