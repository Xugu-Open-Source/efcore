...
{
    public class GraphUpdatesXGTest
    {
        public class ClientCascade : GraphUpdatesXGTestBase<ClientCascade.XGFixture>
        {
            public ClientCascade(XGFixture fixture)
                : base(fixture)
            {
            }
        ...
        public class ClientNoAction : GraphUpdatesXGTestBase<ClientNoAction.XGFixture>
        {
            public ClientNoAction(XGFixture fixture)
                : base(fixture)
            {
            }
        ...
        // public class Identity : GraphUpdatesXGTestBase<Identity.XGFixture>
        // {
        //     public Identity(XGFixture fixture)
        //         : base(fixture)
        //     {
        //     }
        //
