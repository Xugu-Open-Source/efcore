...
public class ComplexTypesTrackingXGTest : ComplexTypesTrackingTestBase<ComplexTypesTrackingXGTest.XGFixture>
{
    public ComplexTypesTrackingXGTest(XGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
    ...
    public class XGFixture : FixtureBase
    {
