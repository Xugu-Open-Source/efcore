...
{
    public class XGTestHelpers : TestHelpers
    {
        ...
        protected override void UseProviderOptions(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseXG("Database=DummyDatabase");
        ...
        public DbContextOptions CreateOptions(Version version, ServerType type)
        {
            ...
            optionsBuilder.UseXG("Database=DummyDatabase", b => b.ServerVersion(version, type));
        ...
        {
            var optionsBuilder = new DbContextOptionsBuilder();
            optionsBuilder.UseXG("Database=DummyDatabase", b => b.CharSetBehavior(charSetBehavior).AnsiCharSet(ansiCharSet).UnicodeCharSet(unicodeCharSet));
