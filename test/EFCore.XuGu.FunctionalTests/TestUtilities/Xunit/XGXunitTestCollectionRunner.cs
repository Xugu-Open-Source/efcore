...
public class XGXunitTestCollectionRunner : XunitTestCollectionRunner
{
    public XGXunitTestCollectionRunner(
    ...
    protected override async Task<RunSummary> RunTestClassesAsync()
    {
        ...
        if (TestCaseOrderer is IXGTestClassOrderer testClassOrderer)
        {
