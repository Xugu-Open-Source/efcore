...
namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.TestUtilities
{
    public class TestXGRetryingExecutionStrategy : XGRetryingExecutionStrategy
    {
        ...
        // TODO: Check for correct XuGu error codes.
...
#pragma warning disable 162
            if (ErrorNumberDebugMode &&
                exception.Message.Contains("[E"))
            {
                var message = exception.Message;//$"Didn't retry on {xgException.ErrorCode} ({(int)xgException.ErrorCode}/0x{(int)xgException.ErrorCode:X8})";
