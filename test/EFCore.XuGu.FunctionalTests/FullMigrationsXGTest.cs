...
DROP PROCEDURE IF EXISTS `XuGu_BEFORE_DROP_PRIMARY_KEY`;

CREATE PROCEDURE `XuGu_BEFORE_DROP_PRIMARY_KEY`(IN `SCHEMA_NAME_ARGUMENT` VARCHAR(255), IN `TABLE_NAME_ARGUMENT` VARCHAR(255))
BEGIN
	...
	END IF;
END;
DROP PROCEDURE IF EXISTS `XuGu_AFTER_ADD_PRIMARY_KEY`;

CREATE PROCEDURE `XuGu_AFTER_ADD_PRIMARY_KEY`(IN `SCHEMA_NAME_ARGUMENT` VARCHAR(255), IN `TABLE_NAME_ARGUMENT` VARCHAR(255), IN `COLUMN_NAME_ARGUMENT` VARCHAR(255))
BEGIN
	...
	END IF;
END;
CALL XuGu_BEFORE_DROP_PRIMARY_KEY(NULL, 'Table1');
...
DROP PROCEDURE `XuGu_BEFORE_DROP_PRIMARY_KEY`;
DROP PROCEDURE `XuGu_AFTER_ADD_PRIMARY_KEY`;
COMMIT;
...
CALL XuGu_BEFORE_DROP_PRIMARY_KEY(NULL, 'FooBar');
