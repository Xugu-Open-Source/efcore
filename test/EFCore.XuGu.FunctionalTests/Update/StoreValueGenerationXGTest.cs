...
public class StoreValueGenerationXGTest : StoreValueGenerationTestBase<
    StoreValueGenerationXGTest.StoreValueGenerationXGFixture>
{
    public StoreValueGenerationXGTest(StoreValueGenerationXGFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    public class StoreValueGenerationXGFixture : StoreValueGenerationFixtureBase
    {
