...
//namespace Microsoft.EntityFrameworkCore.XuGu.FunctionalTests.Update;

//public class StoredProcedureUpdateXGTest : StoredProcedureUpdateTestBase
//{
//    protected override async Task Insert_with_output_parameter(bool async, string createSprocSql)
//    {
...
//    protected override async Task Insert_twice_with_output_parameter(bool async, string createSprocSql)
//    {
...
//    protected override async Task Insert_with_result_column(bool async, string createSprocSql)
//    {
//        var exception =
//            await Assert.ThrowsAsync<InvalidOperationException>(() => base.Insert_with_result_column(async, createSprocSql: ""));

//        Assert.Equal(XGStrings.StoredProcedureResultColumnsNotSupported(nameof(Entity), nameof(Entity) + "_Insert"), exception.Message);
//    }

//    protected override async Task Insert_with_two_result_columns(bool async, string createSprocSql)
//    {
//        var exception =
//            await Assert.ThrowsAsync<InvalidOperationException>(() => base.Insert_with_two_result_columns(async, createSprocSql: ""));

//        Assert.Equal(
//            XGStrings.StoredProcedureResultColumnsNotSupported(
//                nameof(EntityWithAdditionalProperty), nameof(EntityWithAdditionalProperty) + "_Insert"), exception.Message);
//    }

//    protected override async Task Insert_with_output_parameter_and_result_column(bool async, string createSprocSql)
//    {
//        var exception =
//            await Assert.ThrowsAsync<InvalidOperationException>(
//                () => base.Insert_with_output_parameter_and_result_column(async, createSprocSql: ""));

//        Assert.Equal(XGStrings.StoredProcedureResultColumnsNotSupported(nameof(EntityWithAdditionalProperty), nameof(EntityWithAdditionalProperty) + "_Insert"), exception.Message);
//    }

//    protected override async Task Update(bool async, string createSprocSql)
//    {
//        await base.Update(
//            async,
//"""
...
//    protected override async Task Update_partial(bool async, string createSprocSql)
//    {
...
//    protected override async Task Update_with_output_parameter_and_rows_affected_result_column(bool async, string createSprocSql)
//    {
//        var exception =
//            await Assert.ThrowsAsync<InvalidOperationException>(
...
//        Assert.Equal(XGStrings.StoredProcedureResultColumnsNotSupported(nameof(Entity), nameof(Entity) + "_Update"), exception.Message);
//    }
...
//        Assert.Equal(XGStrings.StoredProcedureReturnValueNotSupported(nameof(Entity), nameof(Entity) + "_Update"), exception.Message);
//    }
...
//                    .Property(e => e.Id).UseXGIdentityColumn(); // <--
//            },
