...
{
    public abstract class ManyToManyTrackingXGTestBase<TFixture> : ManyToManyTrackingRelationalTestBase<TFixture>
        where TFixture : ManyToManyTrackingXGTestBase<TFixture>.ManyToManyTrackingXGFixtureBase
    {
        ...
        public class ManyToManyTrackingXGFixtureBase : ManyToManyTrackingRelationalFixture, ITestSqlLoggerFactory
        {
