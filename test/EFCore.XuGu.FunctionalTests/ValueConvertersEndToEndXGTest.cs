...
{
    public class ValueConvertersEndToEndXGTest
        : ValueConvertersEndToEndTestBase<ValueConvertersEndToEndXGTest.ValueConvertersEndToEndXGFixture>
    {
        public ValueConvertersEndToEndXGTest(ValueConvertersEndToEndXGFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class ValueConvertersEndToEndXGFixture : ValueConvertersEndToEndFixtureBase
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                ...
                modelBuilder.Entity<ConvertingEntity>(
                    b =>
                    {
                        // We map DateTimeOffset to XuGu's 'datetime(6)', which doesn't store the time zone.
