...
{
    public class SpatialXGTest : SpatialTestBase<SpatialXGFixture>
    {
        public SpatialXGTest(SpatialXGFixture fixture)
            : base(fixture)
        {
        }
        ...
        [ConditionalFact(Skip = "Point.Empty is currently not supported by XuGu and MariaDB.")]
