...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class XuGuDbReferenceReferenceBuilderExtensions
    {
        /// <summary>
        ...
        public static ReferenceReferenceBuilder ForXuGuDbHasConstraintName(
            ...
            [CanBeNull] string name)
        {
            ...
            referenceReferenceBuilder.Metadata.XuGuDb().Name = name;
        ...
        public static ReferenceReferenceBuilder<TEntity, TRelatedEntity> ForXuGuDbHasConstraintName<TEntity, TRelatedEntity>(
            [NotNull] this ReferenceReferenceBuilder<TEntity, TRelatedEntity> referenceReferenceBuilder,
            [CanBeNull] string name)
            where TEntity : class
            where TRelatedEntity : class
            => (ReferenceReferenceBuilder<TEntity, TRelatedEntity>)ForXuGuDbHasConstraintName(
