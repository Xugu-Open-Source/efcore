...
namespace Microsoft.EntityFrameworkCore.ValueGeneration.Internal
{
    ...
    /// </summary>
    public class XuGuDbSequenceHiLoValueGenerator<TValue> : HiLoValueGenerator<TValue>
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XuGuDbSequenceHiLoValueGenerator(
            [NotNull] IRawSqlCommandBuilder rawSqlCommandBuilder,
            [NotNull] IXuGuDbUpdateSqlGenerator sqlGenerator,
            [NotNull] XuGuDbSequenceValueGeneratorState generatorState,
