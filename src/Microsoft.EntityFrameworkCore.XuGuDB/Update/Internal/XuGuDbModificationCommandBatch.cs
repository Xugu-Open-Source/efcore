...
namespace Microsoft.EntityFrameworkCore.Update.Internal
{
    ...
    /// </summary>
    public class XuGuDbModificationCommandBatch : AffectedCountModificationCommandBatch
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XuGuDbModificationCommandBatch(
            [NotNull] IRelationalCommandBuilderFactory commandBuilderFactory,
            [NotNull] ISqlGenerationHelper sqlGenerationHelper,
            // ReSharper disable once SuggestBaseTypeForParameter
            [NotNull] IXuGuDbUpdateSqlGenerator updateSqlGenerator,
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected new virtual IXuGuDbUpdateSqlGenerator UpdateSqlGenerator => (IXuGuDbUpdateSqlGenerator)base.UpdateSqlGenerator;
        ...
        protected override int ConsumeResultSetWithPropagation(int commandIndex, [NotNull] DbDataReader reader)
        {
            ...
            do
            {
                ...
                if (!reader.HasRows&& !tableModification.ColumnModifications.Any())
                {
