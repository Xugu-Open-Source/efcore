...
namespace Microsoft.EntityFrameworkCore.Query.Internal
{
    ...
    /// </summary>
    public class XuGuDbQueryModelVisitor : RelationalQueryModelVisitor
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XuGuDbQueryModelVisitor(
            ...
            [CanBeNull] XuGuDbQueryModelVisitor parentQueryModelVisitor)
            : base(
        ...
        public override void VisitQueryModel(QueryModel queryModel)
        {
            ...
            if (ContextOptions.FindExtension<XuGuDbOptionsExtension>()?.RowNumberPaging == true)
            {
