...
namespace Microsoft.EntityFrameworkCore.Infrastructure.Internal
{
    ...
    /// </summary>
    public class XGDbOptionsExtension : RelationalOptionsExtension
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGDbOptionsExtension([NotNull] XGDbOptionsExtension copyFrom)
            : base(copyFrom)
        {
