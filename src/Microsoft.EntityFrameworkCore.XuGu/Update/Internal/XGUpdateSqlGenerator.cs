...
namespace Microsoft.EntityFrameworkCore.Update.Internal
{
    ...
    {
        public XGUpdateSqlGenerator([NotNull] ISqlGenerationHelper SqlGenerationHelper)
            ...
            int commandPosition)
        {
            ...
            for (var i = 0; i < statementCount; i++)
            {
                ...
                //commandStringBuilder.Append(" RETURNING 1");
        ...
        private void AppendUpdateOutputClause(StringBuilder commandStringBuilder, string schema, string name, IReadOnlyList<ColumnModification> readOperations, IReadOnlyList<ColumnModification> allOperations)
        {
            if (readOperations.Count() > 0)
            {
                ...
                commandStringBuilder.Append("ROWNUM");
        ...
        protected override void AppendIdentityWhereCondition(StringBuilder commandStringBuilder, ColumnModification columnModification)
        {
            ...
            commandStringBuilder.Append(" = ");
            if (columnModification.IsKey && columnModification.Value != null && columnModification.Property.ClrType == typeof(Guid))
            {
                commandStringBuilder.Append("'"+columnModification.Value.ToString()+"'");
            }
            else
            {
        ...
        {
            Check.NotNull(commandStringBuilder, nameof(commandStringBuilder))
                .Append("ROWNUM = " + expectedRowsAffected);
        }
    }
}
