...
namespace Microsoft.EntityFrameworkCore.Xugu.Query.Internal
{
    ...
    /// </summary>
    public class XuguFullTextSearchFunctionsTranslator : IMethodCallTranslator
    {
        private const string FreeTextFunctionName = "CONTAINS";
        ...
        private static readonly MethodInfo _freeTextMethodInfo
            = typeof(XuguDbFunctionsExtensions).GetRequiredRuntimeMethod(
                nameof(XuguDbFunctionsExtensions.FreeText), typeof(DbFunctions), typeof(object), typeof(string));

        private static readonly MethodInfo _freeTextMethodInfoWithLanguage
            = typeof(XuguDbFunctionsExtensions).GetRequiredRuntimeMethod(
                nameof(XuguDbFunctionsExtensions.FreeText), typeof(DbFunctions), typeof(object), typeof(string), typeof(int));

        private static readonly MethodInfo _containsMethodInfo
            = typeof(XuguDbFunctionsExtensions).GetRequiredRuntimeMethod(
                nameof(XuguDbFunctionsExtensions.Contains), typeof(DbFunctions), typeof(object), typeof(string));

        private static readonly MethodInfo _containsMethodInfoWithLanguage
            = typeof(XuguDbFunctionsExtensions).GetRequiredRuntimeMethod(
                nameof(XuguDbFunctionsExtensions.Contains), typeof(DbFunctions), typeof(object), typeof(string), typeof(int));
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public XuguFullTextSearchFunctionsTranslator(ISqlExpressionFactory sqlExpressionFactory)
        {
            ...
            IDiagnosticsLogger<DbLoggerCategory.Query> logger)
        {
            ...
            if (_functionMapping.TryGetValue(method, out var functionName))
            {
                ...
                {
                    throw new InvalidOperationException(XuguStrings.InvalidColumnNameForFreeText);
                }
