...
namespace Microsoft.EntityFrameworkCore.Xugu.Storage.Internal
{
    ...
    public class XuguExecutionStrategy : IExecutionStrategy
    {
            ...
            Func<DbContext, TState, ExecutionResult<TResult>>? verifySucceeded)
        {
            ...
            catch (Exception ex) when (ExecutionStrategy.CallOnWrappedException(ex, XuguTransientExceptionDetector.ShouldRetryOn))
            {
                throw new InvalidOperationException(XuguStrings.TransientExceptionDetected, ex);
            }
        }
