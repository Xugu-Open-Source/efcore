...
namespace Microsoft.EntityFrameworkCore.Xugu.Storage.Internal
{
    ...
    public class XuguByteArrayTypeMapping : ByteArrayTypeMapping
    {
        ...
        public XuguByteArrayTypeMapping(
            ...
            : this(
                new RelationalTypeMappingParameters(
                    ...
                    storeType ?? (fixedLength ? "binary" : "binary"),
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected XuguByteArrayTypeMapping(RelationalTypeMappingParameters parameters, SqlDbType? sqlDbType)
            : base(parameters)
        {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new XuguByteArrayTypeMapping(parameters, _sqlDbType);
