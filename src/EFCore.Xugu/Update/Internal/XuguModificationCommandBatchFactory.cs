...
namespace Microsoft.EntityFrameworkCore.Xugu.Update.Internal
{
    ...
    public class XuguModificationCommandBatchFactory : IModificationCommandBatchFactory
    {
        ...
        {
            var optionsExtension = _options.Extensions.OfType<XuguOptionsExtension>().FirstOrDefault();

            return new XuguModificationCommandBatch(Dependencies, optionsExtension?.MaxBatchSize);
        }
    }
}
