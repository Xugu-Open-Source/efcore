...
namespace Microsoft.EntityFrameworkCore.Xugu.Internal
{
    ...
    public static class XuguStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.Xugu.Properties.XuguStrings", typeof(XuguStrings).Assembly);
        ...
        /// <summary>
        ///     An exception has been raised that is likely due to a transient failure. Consider enabling transient error resiliency by adding 'EnableRetryOnFailure' to the 'UseXugu' call.
        /// </summary>
...
namespace Microsoft.EntityFrameworkCore.Xugu.Internal
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class XuguResources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.Xugu.Properties.XuguStrings", typeof(XuguResources).Assembly);
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogByteIdentityColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogByteIdentityColumn,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.ByteIdentityColumnWarning,
                        LogLevel.Warning,
                        "XuguEventId.ByteIdentityColumnWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogColumnWithoutType;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogColumnWithoutType,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.ColumnWithoutTypeWarning,
                        LogLevel.Warning,
                        "XuguEventId.ColumnWithoutTypeWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        /// <summary>
        ///     Both the XuguValueGenerationStrategy '{generationStrategy}' and '{otherGenerationStrategy}' have been set on property '{propertyName}' on entity type '{entityName}'. Configuring two strategies is usually unintentional and will likely result in a database error.
        /// </summary>
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogConflictingValueGenerationStrategies,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        XuguEventId.ConflictingValueGenerationStrategiesWarning,
                        LogLevel.Warning,
                        "XuguEventId.ConflictingValueGenerationStrategiesWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDecimalTypeKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDecimalTypeKey,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.DecimalTypeKeyWarning,
                        LogLevel.Warning,
                        "XuguEventId.DecimalTypeKeyWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDefaultDecimalTypeColumn,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.DecimalTypeDefaultWarning,
                        LogLevel.Warning,
                        "XuguEventId.DecimalTypeDefaultWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDuplicateForeignKeyConstraintIgnored;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogDuplicateForeignKeyConstraintIgnored,
                    logger,
                    static logger => new EventDefinition<string, string, string>(
                        logger.Options,
                        XuguEventId.DuplicateForeignKeyConstraintIgnored,
                        LogLevel.Warning,
                        "XuguEventId.DuplicateForeignKeyConstraintIgnored",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        XuguEventId.ColumnFound,
                        LogLevel.Debug,
                        "XuguEventId.ColumnFound",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundDefaultSchema,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        XuguEventId.DefaultSchemaFound,
                        LogLevel.Debug,
                        "XuguEventId.DefaultSchemaFound",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        XuguEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "XuguEventId.ForeignKeyFound",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    logger,
                    static logger => new EventDefinition<string, string, bool>(
                        logger.Options,
                        XuguEventId.IndexFound,
                        LogLevel.Debug,
                        "XuguEventId.IndexFound",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "XuguEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        XuguEventId.SequenceFound,
                        LogLevel.Debug,
                        "XuguEventId.SequenceFound",
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundTable,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        XuguEventId.TableFound,
                        LogLevel.Debug,
                        "XuguEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundTypeAlias;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundTypeAlias,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.TypeAliasFound,
                        LogLevel.Debug,
                        "XuguEventId.TypeAliasFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "XuguEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        XuguEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "XuguEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogMissingTable,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        XuguEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "XuguEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        XuguEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "XuguEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalTableInformationNotFound;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalTableInformationNotFound,
                    logger,
                    static logger => new EventDefinition<string?, string?>(
                        logger.Options,
                        XuguEventId.ForeignKeyReferencesUnknownPrincipalTableWarning,
                        LogLevel.Warning,
                        "XuguEventId.ForeignKeyReferencesUnknownPrincipalTableWarning",
                        level => LoggerMessage.Define<string?, string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    logger,
                    static logger => new EventDefinition<string?, string?, string?>(
                        logger.Options,
                        XuguEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "XuguEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
                        level => LoggerMessage.Define<string?, string?, string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogReflexiveConstraintIgnored,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        XuguEventId.ReflexiveConstraintIgnored,
                        LogLevel.Debug,
                        "XuguEventId.ReflexiveConstraintIgnored",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        /// <summary>
        ///     Savepoints are disabled because Multiple Active Result Sets (MARS) is enabled. If 'SaveChanges' fails, then the transaction cannot be automatically rolled back to a known clean state. Instead, the transaction should be rolled back by the application before retrying 'SaveChanges'. See https://go.microsoft.com/fwlink/?linkid=2149338 for more information. To identify the code which triggers this warning, call 'ConfigureWarnings(w =&gt; w.Throw(XuguEventId.SavepointsDisabledBecauseOfMARS))'.
        /// </summary>
        public static EventDefinition LogSavepointsDisabledBecauseOfMARS(IDiagnosticsLogger logger)
        {
            var definition = ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogSavepointsDisabledBecauseOfMARS;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.XuguLoggingDefinitions)logger.Definitions).LogSavepointsDisabledBecauseOfMARS,
                    logger,
                    static logger => new EventDefinition(
                        logger.Options,
                        XuguEventId.SavepointsDisabledBecauseOfMARS,
                        LogLevel.Warning,
                        "XuguEventId.SavepointsDisabledBecauseOfMARS",
