...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </remarks>
    public static class XuguEntityTypeExtensions
    {
        ...
        public static bool IsMemoryOptimized(this IReadOnlyEntityType entityType)
            => entityType[XuguAnnotationNames.MemoryOptimized] as bool? ?? false;
        ...
        public static void SetIsMemoryOptimized(this IMutableEntityType entityType, bool memoryOptimized)
            => entityType.SetOrRemoveAnnotation(XuguAnnotationNames.MemoryOptimized, memoryOptimized);
        ...
        {
            entityType.SetOrRemoveAnnotation(XuguAnnotationNames.MemoryOptimized, memoryOptimized, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetIsMemoryOptimizedConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.MemoryOptimized)?.GetConfigurationSource();
        ...
        public static bool IsTemporal(this IReadOnlyEntityType entityType)
            => entityType[XuguAnnotationNames.IsTemporal] as bool? ?? false;
        ...
        public static void SetIsTemporal(this IMutableEntityType entityType, bool temporal)
            => entityType.SetOrRemoveAnnotation(XuguAnnotationNames.IsTemporal, temporal);
        ...
        public static bool? SetIsTemporal(
            ...
            bool fromDataAnnotation = false)
        {
            entityType.SetOrRemoveAnnotation(XuguAnnotationNames.IsTemporal, temporal, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetIsTemporalConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.IsTemporal)?.GetConfigurationSource();
        ...
        public static string? GetPeriodStartPropertyName(this IReadOnlyEntityType entityType)
            => (entityType is RuntimeEntityType)
                ...
                : entityType[XuguAnnotationNames.TemporalPeriodStartPropertyName] as string;
        ...
        public static void SetPeriodStartPropertyName(this IMutableEntityType entityType, string? periodStartPropertyName)
            => entityType.SetAnnotation(XuguAnnotationNames.TemporalPeriodStartPropertyName, periodStartPropertyName);
            ...
            bool fromDataAnnotation = false)
        {
            entityType.SetAnnotation(
                XuguAnnotationNames.TemporalPeriodStartPropertyName,
        ...
        public static ConfigurationSource? GetPeriodStartPropertyNameConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.TemporalPeriodStartPropertyName)?.GetConfigurationSource();
        ...
        public static string? GetPeriodEndPropertyName(this IReadOnlyEntityType entityType)
            => (entityType is RuntimeEntityType)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : entityType[XuguAnnotationNames.TemporalPeriodEndPropertyName] as string;
        ...
        public static void SetPeriodEndPropertyName(this IMutableEntityType entityType, string? periodEndPropertyName)
            => entityType.SetAnnotation(XuguAnnotationNames.TemporalPeriodEndPropertyName, periodEndPropertyName);
        ...
        {
            entityType.SetAnnotation(
                XuguAnnotationNames.TemporalPeriodEndPropertyName,
        ...
        public static ConfigurationSource? GetPeriodEndPropertyNameConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.TemporalPeriodEndPropertyName)?.GetConfigurationSource();
        ...
        public static string? GetHistoryTableName(this IReadOnlyEntityType entityType)
            => (entityType is RuntimeEntityType)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : entityType[XuguAnnotationNames.TemporalHistoryTableName] is string historyTableName
                    ? historyTableName
                    : entityType[XuguAnnotationNames.IsTemporal] as bool? == true
        ...
        public static void SetHistoryTableName(this IMutableEntityType entityType, string? historyTableName)
            => entityType.SetAnnotation(XuguAnnotationNames.TemporalHistoryTableName, historyTableName);
        ...
        public static ConfigurationSource? GetHistoryTableNameConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.TemporalHistoryTableName)?.GetConfigurationSource();
        ...
        public static string? GetHistoryTableSchema(this IReadOnlyEntityType entityType)
            => (entityType is RuntimeEntityType)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : entityType[XuguAnnotationNames.TemporalHistoryTableSchema] as string
        ...
        public static void SetHistoryTableSchema(this IMutableEntityType entityType, string? historyTableSchema)
            => entityType.SetAnnotation(XuguAnnotationNames.TemporalHistoryTableSchema, historyTableSchema);
        ...
        public static ConfigurationSource? GetHistoryTableSchemaConfigurationSource(this IConventionEntityType entityType)
            => entityType.FindAnnotation(XuguAnnotationNames.TemporalHistoryTableSchema)?.GetConfigurationSource();
    }
}
