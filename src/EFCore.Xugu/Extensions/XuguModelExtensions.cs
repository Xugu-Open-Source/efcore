...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class XuguModelExtensions
    {
        ...
        public static string GetHiLoSequenceName(this IReadOnlyModel model)
            => (string?)model[XuguAnnotationNames.HiLoSequenceName]
        ...
        public static void SetHiLoSequenceName(this IMutableModel model, string? name)
        {
            ...
            model.SetOrRemoveAnnotation(XuguAnnotationNames.HiLoSequenceName, name);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            model.SetOrRemoveAnnotation(XuguAnnotationNames.HiLoSequenceName, name, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetHiLoSequenceNameConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.HiLoSequenceName)?.GetConfigurationSource();

        /// <summary>
        ///     Returns the schema to use for the default hi-lo sequence.
        ///     <see cref="XuguPropertyBuilderExtensions.UseHiLo" />
        /// </summary>
        /// <param name="model">The model.</param>
        ...
        public static string? GetHiLoSequenceSchema(this IReadOnlyModel model)
            => (string?)model[XuguAnnotationNames.HiLoSequenceSchema];
        ...
        public static void SetHiLoSequenceSchema(this IMutableModel model, string? value)
        {
            ...
            model.SetOrRemoveAnnotation(XuguAnnotationNames.HiLoSequenceSchema, value);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            model.SetOrRemoveAnnotation(XuguAnnotationNames.HiLoSequenceSchema, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetHiLoSequenceSchemaConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.HiLoSequenceSchema)?.GetConfigurationSource();
        ...
        public static long GetIdentitySeed(this IReadOnlyModel model)
        {
            ...
            var annotation = model.FindAnnotation(XuguAnnotationNames.IdentitySeed);
        ...
        public static ConfigurationSource? GetIdentitySeedConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.IdentitySeed)?.GetConfigurationSource();
        ...
        public static int GetIdentityIncrement(this IReadOnlyModel model)
            => (model is RuntimeModel)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : (int?)model[XuguAnnotationNames.IdentityIncrement] ?? 1;
        ...
        public static ConfigurationSource? GetIdentityIncrementConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.IdentityIncrement)?.GetConfigurationSource();

        /// <summary>
        ///     Returns the <see cref="XuguValueGenerationStrategy" /> to use for properties
        ///     of keys in the model, unless the property has a strategy explicitly set.
        /// </summary>
        /// <param name="model">The model.</param>
        /// <returns>The default <see cref="XuguValueGenerationStrategy" />.</returns>
        public static XuguValueGenerationStrategy? GetValueGenerationStrategy(this IReadOnlyModel model)
            => (XuguValueGenerationStrategy?)model[XuguAnnotationNames.ValueGenerationStrategy];

        /// <summary>
        ///     Sets the <see cref="XuguValueGenerationStrategy" /> to use for properties
        ...
        /// <summary>
        ///     Returns the <see cref="ConfigurationSource" /> for the default <see cref="XuguValueGenerationStrategy" />.
        /// </summary>
        /// <param name="model">The model.</param>
        /// <returns>The <see cref="ConfigurationSource" /> for the default <see cref="XuguValueGenerationStrategy" />.</returns>
        ...
        public static string? GetDatabaseMaxSize(this IReadOnlyModel model)
            => (model is RuntimeModel)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : (string?)model[XuguAnnotationNames.MaxDatabaseSize];
        ...
        public static void SetDatabaseMaxSize(this IMutableModel model, string? value)
            => model.SetOrRemoveAnnotation(XuguAnnotationNames.MaxDatabaseSize, value);
        ...
        public static string? SetDatabaseMaxSize(
            ...
            bool fromDataAnnotation = false)
        {
            model.SetOrRemoveAnnotation(XuguAnnotationNames.MaxDatabaseSize, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetDatabaseMaxSizeConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.MaxDatabaseSize)?.GetConfigurationSource();
        ...
        public static string? GetServiceTierSql(this IReadOnlyModel model)
            => (model is RuntimeModel)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : (string?)model[XuguAnnotationNames.ServiceTierSql];
        ...
        public static void SetServiceTierSql(this IMutableModel model, string? value)
            => model.SetOrRemoveAnnotation(XuguAnnotationNames.ServiceTierSql, value);
        ...
        public static string? SetServiceTierSql(
            ...
            bool fromDataAnnotation = false)
        {
            model.SetOrRemoveAnnotation(XuguAnnotationNames.ServiceTierSql, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetServiceTierSqlConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.ServiceTierSql)?.GetConfigurationSource();
        ...
        public static string? GetPerformanceLevelSql(this IReadOnlyModel model)
            => (model is RuntimeModel)
                ? throw new InvalidOperationException(CoreStrings.RuntimeModelMissingData)
                : (string?)model[XuguAnnotationNames.PerformanceLevelSql];
        ...
        public static void SetPerformanceLevelSql(this IMutableModel model, string? value)
            => model.SetOrRemoveAnnotation(XuguAnnotationNames.PerformanceLevelSql, value);
        ...
        public static string? SetPerformanceLevelSql(
            ...
            bool fromDataAnnotation = false)
        {
            model.SetOrRemoveAnnotation(XuguAnnotationNames.PerformanceLevelSql, value, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetPerformanceLevelSqlConfigurationSource(this IConventionModel model)
            => model.FindAnnotation(XuguAnnotationNames.PerformanceLevelSql)?.GetConfigurationSource();
    }
}
