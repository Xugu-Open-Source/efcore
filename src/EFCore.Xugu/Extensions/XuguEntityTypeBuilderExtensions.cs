...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class XuguEntityTypeBuilderExtensions
    {
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(XuguAnnotationNames.MemoryOptimized, memoryOptimized, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(XuguAnnotationNames.IsTemporal, temporal, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(XuguAnnotationNames.TemporalHistoryTableName, name, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(XuguAnnotationNames.TemporalHistoryTableSchema, schema, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(
                XuguAnnotationNames.TemporalPeriodStartPropertyName, propertyName, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(
                XuguAnnotationNames.TemporalPeriodEndPropertyName, propertyName, fromDataAnnotation);
        }
    }
}
