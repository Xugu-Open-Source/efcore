...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </remarks>
    public static class XuguKeyExtensions
    {
        /// <summary>
        ...
        public static bool? IsClustered(this IReadOnlyKey key)
            => (key is RuntimeKey)
                ...
                : (bool?)key[XuguAnnotationNames.Clustered];
        ...
        public static bool? IsClustered(this IReadOnlyKey key, in StoreObjectIdentifier storeObject)
        {
            ...
            var annotation = key.FindAnnotation(XuguAnnotationNames.Clustered);
            if (annotation != null)
            {
        ...
        public static void SetIsClustered(this IMutableKey key, bool? clustered)
            => key.SetOrRemoveAnnotation(XuguAnnotationNames.Clustered, clustered);
        ...
        {
            key.SetOrRemoveAnnotation(XuguAnnotationNames.Clustered, clustered, fromDataAnnotation);
        ...
        public static ConfigurationSource? GetIsClusteredConfigurationSource(this IConventionKey key)
            => key.FindAnnotation(XuguAnnotationNames.Clustered)?.GetConfigurationSource();
    }
}
