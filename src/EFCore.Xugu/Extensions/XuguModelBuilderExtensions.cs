...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class XuguModelBuilderExtensions
    {
            ...
            string? schema = null)
        {
            ...
            name ??= XuguModelExtensions.DefaultHiLoSequenceName;
            ...
            model.SetValueGenerationStrategy(XuguValueGenerationStrategy.SequenceHiLo);
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.HiLoSequenceName, name, fromDataAnnotation)
                && modelBuilder.CanSetAnnotation(XuguAnnotationNames.HiLoSequenceSchema, schema, fromDataAnnotation);
        }
            ...
            int increment = 1)
        {
            ...
            model.SetValueGenerationStrategy(XuguValueGenerationStrategy.IdentityColumn);
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.IdentitySeed, seed, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.IdentityIncrement, increment, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            if (modelBuilder.CanSetValueGenerationStrategy(valueGenerationStrategy, fromDataAnnotation))
            {
                ...
                if (valueGenerationStrategy != XuguValueGenerationStrategy.IdentityColumn)
                {
                ...
                if (valueGenerationStrategy != XuguValueGenerationStrategy.SequenceHiLo)
                {
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(
                XuguAnnotationNames.ValueGenerationStrategy, valueGenerationStrategy, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.MaxDatabaseSize, maxSize, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.ServiceTierSql, serviceTier, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return modelBuilder.CanSetAnnotation(XuguAnnotationNames.PerformanceLevelSql, performanceLevel, fromDataAnnotation);
        }
    }
}
