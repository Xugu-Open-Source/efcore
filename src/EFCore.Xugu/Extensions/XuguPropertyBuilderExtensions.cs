...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class XuguPropertyBuilderExtensions
    {
            ...
            string? schema = null)
        {
            ...
            property.SetValueGenerationStrategy(XuguValueGenerationStrategy.SequenceHiLo);
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return propertyBuilder.CanSetAnnotation(XuguAnnotationNames.HiLoSequenceName, name, fromDataAnnotation)
                && propertyBuilder.CanSetAnnotation(XuguAnnotationNames.HiLoSequenceSchema, schema, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return propertyBuilder.CanSetAnnotation(XuguAnnotationNames.IdentitySeed, seed, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return propertyBuilder.CanSetAnnotation(XuguAnnotationNames.IdentityIncrement, increment, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return (valueGenerationStrategy == null
                    || XuguPropertyExtensions.IsCompatibleWithValueGeneration(propertyBuilder.Metadata))
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return property.CanSetAnnotation(XuguAnnotationNames.Sparse, sparse, fromDataAnnotation);
        }
    }
}
