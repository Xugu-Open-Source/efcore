    ...
    public class XuguModelValidator : RelationalModelValidator
    {
                ...
                foreach (var property in entityType.GetDeclaredProperties()
                    .Where(
                        p => p.ClrType.UnwrapNullableType() == typeof(byte)
                            && p.GetValueGenerationStrategy() == XuguValueGenerationStrategy.IdentityColumn))
                {
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            foreach (var entityType in model.GetEntityTypes())
            {
                foreach (var property in entityType.GetDeclaredProperties()
                    .Where(
                        p => p.GetValueGenerationStrategy() == XuguValueGenerationStrategy.SequenceHiLo
                            && ((IConventionProperty)p).GetValueGenerationStrategyConfigurationSource() != null
                            && !p.IsKey()
                            && p.ValueGenerated != ValueGenerated.Never
                            && (!(p.FindAnnotation(XuguAnnotationNames.ValueGenerationStrategy) is IConventionAnnotation strategy)
                                || !ConfigurationSource.Convention.Overrides(strategy.GetConfigurationSource()))))
                {
                    throw new InvalidOperationException(
                        XuguStrings.NonKeyValueGeneration(property.Name, property.DeclaringEntityType.DisplayName()));
                }
            }
        }
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            foreach (var index in model.GetEntityTypes().SelectMany(t => t.GetDeclaredIndexes()))
            {
                ...
                if (includeProperties?.Count > 0)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            XuguStrings.IncludePropertyNotFound(
                                notFound,
                    ...
                    {
                        throw new InvalidOperationException(
                            XuguStrings.IncludePropertyDuplicated(
                                index.DeclaringEntityType.DisplayName(),
                                duplicateProperty,
                                index.Name == null ? index.Properties.Format() : "'" + index.Name + "'"));
                    }
                    ...
                    {
                        throw new InvalidOperationException(
                            XuguStrings.IncludePropertyInIndex(
                                index.DeclaringEntityType.DisplayName(),
                                coveredProperty,
                                index.Name == null ? index.Properties.Format() : "'" + index.Name + "'"));
                    }
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            foreach (var temporalEntityType in temporalEntityTypes)
            {
                ...
                {
                    throw new InvalidOperationException(XuguStrings.TemporalOnlyOnRoot(temporalEntityType.DisplayName()));
                }
                ...
                {
                    throw new InvalidOperationException(XuguStrings.TemporalOnlySupportedForTPH(temporalEntityType.DisplayName()));
                }
            }
        }
        ...
        private void ValidateTemporalPeriodProperty(IEntityType temporalEntityType, bool periodStart)
        {
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalMustDefinePeriodProperties(
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalExpectedPeriodPropertyNotFound(
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalPeriodPropertyMustBeInShadowState(
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalPeriodPropertyMustBeNonNullableDateTime(
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalPeriodPropertyMustBeMappedToDatetime2(
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.TemporalPeriodPropertyCantHaveDefaultValue(
                        temporalEntityType.DisplayName(), periodProperty.Name));
            }
            ...
            if (temporalEntityType.GetTableName() is string tableName)
            {
                ...
                foreach (var propertyMappedToPeriodColumn in propertiesMappedToPeriodColumn)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            XuguStrings.TemporalPropertyMappedToPeriodColumnMustBeValueGeneratedOnAddOrUpdate(
                    ...
                    {
                        throw new InvalidOperationException(
                            XuguStrings.TemporalPropertyMappedToPeriodColumnCantHaveDefaultValue(
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            foreach (var otherMappedType in mappedTypes.Skip(1))
            {
                ...
                {
                    throw new InvalidOperationException(
                        XuguStrings.IncompatibleTableMemoryOptimizedMismatch(
            ...
            {
                throw new InvalidOperationException(XuguStrings.TemporalNotSupportedForTableSplitting(tableName));
            }
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            {
                if (property.GetValueGenerationStrategy(storeObject) == XuguValueGenerationStrategy.IdentityColumn)
                {
            ...
            if (identityColumns.Count > 1)
            {
                ...
                throw new InvalidOperationException(XuguStrings.MultipleIdentityColumns(sb, storeObject.DisplayName()));
            }
        }
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            if (propertyStrategy != duplicatePropertyStrategy)
            {
                var isConflicting = ((IConventionProperty)property)
                    .FindAnnotation(XuguAnnotationNames.ValueGenerationStrategy)
                    ?.GetConfigurationSource()
                    == ConfigurationSource.Explicit
                    || propertyStrategy != XuguValueGenerationStrategy.None;
                var isDuplicateConflicting = ((IConventionProperty)duplicateProperty)
                    .FindAnnotation(XuguAnnotationNames.ValueGenerationStrategy)
                    ?.GetConfigurationSource()
                    == ConfigurationSource.Explicit
                    || duplicatePropertyStrategy != XuguValueGenerationStrategy.None;

                if (isConflicting && isDuplicateConflicting)
                {
                    throw new InvalidOperationException(
                        XuguStrings.DuplicateColumnNameValueGenerationStrategyMismatch(
            ...
            else
            {
                switch (propertyStrategy)
                {
                    case XuguValueGenerationStrategy.IdentityColumn:
                        ...
                        {
                            throw new InvalidOperationException(
                                XuguStrings.DuplicateColumnIdentityIncrementMismatch(
                                    duplicateProperty.DeclaringEntityType.DisplayName(),
                                    duplicateProperty.Name,
                                    property.DeclaringEntityType.DisplayName(),
                                    property.Name,
                        ...
                        {
                            throw new InvalidOperationException(
                                XuguStrings.DuplicateColumnIdentitySeedMismatch(
                                    duplicateProperty.DeclaringEntityType.DisplayName(),
                                    duplicateProperty.Name,
                                    property.DeclaringEntityType.DisplayName(),
                                    property.Name,
                    ...
                    case XuguValueGenerationStrategy.SequenceHiLo:
                        ...
                        {
                            throw new InvalidOperationException(
                                XuguStrings.DuplicateColumnSequenceMismatch(
                                    duplicateProperty.DeclaringEntityType.DisplayName(),
                                    duplicateProperty.Name,
                                    property.DeclaringEntityType.DisplayName(),
                                    property.Name,
            ...
            {
                throw new InvalidOperationException(
                    XuguStrings.DuplicateColumnSparsenessMismatch(
                        duplicateProperty.DeclaringEntityType.DisplayName(),
                        duplicateProperty.Name,
                        property.DeclaringEntityType.DisplayName(),
                        property.Name,
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            key.AreCompatibleForXugu(duplicateKey, storeObject, shouldThrow: true);
        }
            ...
            IDiagnosticsLogger<DbLoggerCategory.Model.Validation> logger)
        {
            ...
            index.AreCompatibleForXugu(duplicateIndex, storeObject, shouldThrow: true);
        }
    }
}
