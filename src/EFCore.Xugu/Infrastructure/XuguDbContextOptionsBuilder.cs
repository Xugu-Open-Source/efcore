...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    ...
    ///     </para>
    ///     <para>
    ///         Instances of this class are returned from a call to <see cref="O:XuguDbContextOptionsExtensions.UseXugu" />
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="XuguDbContextOptionsBuilder" /> class.
        /// </summary>
        ...
        public virtual XuguDbContextOptionsBuilder EnableRetryOnFailure()
            => ExecutionStrategy(c => new XuguRetryingExecutionStrategy(c));
        ...
        public virtual XuguDbContextOptionsBuilder EnableRetryOnFailure(int maxRetryCount)
            => ExecutionStrategy(c => new XuguRetryingExecutionStrategy(c, maxRetryCount));
        ...
        public virtual XuguDbContextOptionsBuilder EnableRetryOnFailure(
            ...
            => ExecutionStrategy(c => new XuguRetryingExecutionStrategy(c, maxRetryCount, maxRetryDelay, errorNumbersToAdd));
    }
}
