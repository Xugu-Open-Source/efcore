    ...
    public class XuguAnnotationProvider : RelationalAnnotationProvider
    {
        ...
        public override IEnumerable<IAnnotation> For(IRelationalModel model, bool designTime)
        {
                ...
                || performanceLevel != null)
            {
                ...
                yield return new Annotation(XuguAnnotationNames.EditionOptions, options.ToString());
            }

            if (model.Tables.Any(t => !t.IsExcludedFromMigrations && (t[XuguAnnotationNames.MemoryOptimized] as bool? == true)))
            {
                yield return new Annotation(XuguAnnotationNames.MemoryOptimized, true);
            }
        }
        ...
        public override IEnumerable<IAnnotation> For(ITable table, bool designTime)
        {
            ...
            if (entityType.IsTemporal() && designTime)
            {
                ...
                yield return new Annotation(XuguAnnotationNames.TemporalHistoryTableName, entityType.GetHistoryTableName());
                yield return new Annotation(XuguAnnotationNames.TemporalHistoryTableSchema, entityType.GetHistoryTableSchema());
                ...
                if (periodStartPropertyName != null)
                {
                    ...
                    yield return new Annotation(XuguAnnotationNames.TemporalPeriodStartColumnName, periodStartColumnName);
                }
                ...
                if (periodEndPropertyName != null)
                {
                    ...
                    yield return new Annotation(XuguAnnotationNames.TemporalPeriodEndColumnName, periodEndColumnName);
                }
            }
        }
        ...
        public override IEnumerable<IAnnotation> For(IUniqueConstraint constraint, bool designTime)
        {
            ...
            {
                yield return new Annotation(XuguAnnotationNames.Clustered, isClustered);
            }
        }
        ...
        public override IEnumerable<IAnnotation> For(ITableIndex index, bool designTime)
        {
            ...
            if (modelIndex.GetIncludeProperties(table) is IReadOnlyList<string> includeProperties)
            {
                ...
                yield return new Annotation(
                    XuguAnnotationNames.Include,
                    includeColumns);
            }

            if (modelIndex.IsCreatedOnline(table) is bool isOnline)
            {
                yield return new Annotation(XuguAnnotationNames.CreatedOnline, isOnline);
            }

            if (modelIndex.GetFillFactor(table) is int fillFactor)
            {
                yield return new Annotation(XuguAnnotationNames.FillFactor, fillFactor);
            }
        }
        ...
        public override IEnumerable<IAnnotation> For(IColumn column, bool designTime)
        {
            ...
            {
                yield return new Annotation(XuguAnnotationNames.Sparse, isSparse);
            }
