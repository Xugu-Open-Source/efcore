...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    ///     or were configured to use a <see cref="XuguValueGenerationStrategy" />.
    ...
    {
        /// <summary>
        ///     Creates a new instance of <see cref="XuguValueGenerationConvention" />.
        /// </summary>
        ...
        public override void ProcessEntityTypeAnnotationChanged(
            ...
            IConventionContext<IConventionAnnotation> context)
        {
            if ((name == XuguAnnotationNames.TemporalPeriodStartPropertyName
                    || name == XuguAnnotationNames.TemporalPeriodEndPropertyName)
        ...
        public new static ValueGenerated? GetValueGenerated(IReadOnlyProperty property, in StoreObjectIdentifier storeObject)
            => RelationalValueGenerationConvention.GetValueGenerated(property, storeObject)
                ?? (property.GetValueGenerationStrategy(storeObject) != XuguValueGenerationStrategy.None
        ...
        private ValueGenerated? GetValueGenerated(
            ...
            => GetTemporalValueGenerated(property, storeObject)
                ?? RelationalValueGenerationConvention.GetValueGenerated(property, storeObject)
                ?? (property.GetValueGenerationStrategy(storeObject, typeMappingSource) != XuguValueGenerationStrategy.None
                    ? ValueGenerated.OnAdd
                    : null);
