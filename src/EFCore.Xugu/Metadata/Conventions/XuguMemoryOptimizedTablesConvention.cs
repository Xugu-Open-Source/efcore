...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    /// </remarks>
    public class XuguMemoryOptimizedTablesConvention :
        IEntityTypeAnnotationChangedConvention,
        IKeyAddedConvention,
        IIndexAddedConvention
    {
        /// <summary>
        ///     Creates a new instance of <see cref="XuguMemoryOptimizedTablesConvention" />.
        /// </summary>
        /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
        /// <param name="relationalDependencies"> Parameter object containing relational dependencies for this convention.</param>
        public XuguMemoryOptimizedTablesConvention(
        ...
        {
            if (name == XuguAnnotationNames.MemoryOptimized)
            {
