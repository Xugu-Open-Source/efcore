...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    /// </remarks>
    public class XuguTemporalConvention : IEntityTypeAnnotationChangedConvention, ISkipNavigationForeignKeyChangedConvention
    {
        private const string PeriodStartDefaultName = "PeriodStart";
        private const string PeriodEndDefaultName = "PeriodEnd";

        /// <summary>
        ///     Creates a new instance of <see cref="XuguTemporalConvention" />.
        /// </summary>
        /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
        /// <param name="relationalDependencies">Parameter object containing relational dependencies for this convention.</param>
        public XuguTemporalConvention(
        ...
        {
            if (name == XuguAnnotationNames.IsTemporal)
            {
