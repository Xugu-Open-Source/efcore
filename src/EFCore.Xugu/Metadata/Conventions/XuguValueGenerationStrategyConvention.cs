...
{
    /// <summary>
    ///     A convention that configures the default model <see cref="XuguValueGenerationStrategy" /> as
    ///     <see cref="XuguValueGenerationStrategy.IdentityColumn" />.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        ///     Creates a new instance of <see cref="XuguValueGenerationStrategyConvention" />.
        /// </summary>
            ...
            IConventionContext<IConventionModelBuilder> context)
        {
            ...
            bool IsStrategyNoneNeeded(IReadOnlyProperty property, StoreObjectIdentifier storeObject)
            {
                if (property.ValueGenerated == ValueGenerated.OnAdd
                    ...
                    && property.DeclaringEntityType.Model.GetValueGenerationStrategy() == XuguValueGenerationStrategy.IdentityColumn)
                {
