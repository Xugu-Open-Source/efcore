...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class XGJsonNewtonsoftDbContextOptionsBuilderExtensions
    {
        /// <summary>
        ///     Use Newtonsoft.Json (JSON.NET) to access XG JSON data.
        /// </summary>
        ...
        public static XGDbContextOptionsBuilder UseNewtonsoftJson(
            ...
            XGCommonJsonChangeTrackingOptions options = XGCommonJsonChangeTrackingOptions.RootPropertyOnly)
        {
            ...
            var extension = (coreOptionsBuilder.Options.FindExtension<XGJsonNewtonsoftOptionsExtension>() ??
