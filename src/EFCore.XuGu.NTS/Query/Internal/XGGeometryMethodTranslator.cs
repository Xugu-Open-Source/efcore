...
{
    public class XGGeometryMethodTranslator : IMethodCallTranslator
    {
        ...
        public XGGeometryMethodTranslator(
            ...
            return _sqlExpressionFactory.Case(
                new[]
                {
                    new CaseWhenClause(
                        ...
                        XGSpatialDbFunctionsExtensionsMethodTranslator.GetStDistanceSphereFunctionCall(
                            left,
                            right,
                ...
                XGSpatialDbFunctionsExtensionsMethodTranslator.GetStDistanceFunctionCall(
                    left,
                    right,
                    resultType,
                    resultTypeMapping,
