...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public enum SpatialDistanceAlgorithm
    {
        ...
        Native,
        /// <summary>
        /// For XuGu, uses the native server implementation of the `ST_Distance()` function, which already
    ...
    /// </summary>
    public static class XGSpatialDbFunctionsExtensions
    {
        /// <summary>
        ...
        ///     For XuGu 8, this is equivalent of calling ST_Distance() when using an SRID of `0`.
        ///     For XuGu &lt; 8 and MariaDB, this is equivalent of calling ST_Distance() with any SRID.
        /// </summary>
