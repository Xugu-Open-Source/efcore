...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public enum SpatialDistanceAlgorithm
    {
        ...
        Native,
        /// <summary>
        /// For XG, uses the native server implementation of the `ST_Distance()` function, which already
    ...
    public static class XGSpatialDbFunctionsExtensions
    {
        ...
        ///     For XG 8, this is equivalent of calling ST_Distance() when using an SRID of `0`.
        ///     For XG &lt; 8 and MariaDB, this is equivalent of calling ST_Distance() with any SRID.
        /// </summary>
