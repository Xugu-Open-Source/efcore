...
//namespace Microsoft.EntityFrameworkCore.XuGu.Storage.ValueConversion.Internal
//{
...
//    /// </summary>
//    public class GeometryValueConverter<TGeometry> : ValueConverter<TGeometry, XGGeometry>
...
//        private static XGGeometry ConvertToProviderCore(TGeometry v)
//            => XGGeometry.FromWkb(v.SRID, v.ToBinary());

//        private static TGeometry ConvertFromProviderCore(XGGeometry v)
//        {
//            using var memoryStream = new MemoryStream(v.Value);

//            // XuGu starts it's spatial data with a 4 byte SRID, that is unexpected by WKBReader.
