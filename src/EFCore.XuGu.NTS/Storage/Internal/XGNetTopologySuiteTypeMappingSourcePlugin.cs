...
namespace EntityFrameworkCore.XuGu.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class XGNetTopologySuiteTypeMappingSourcePlugin : IRelationalTypeMappingSourcePlugin
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public XGNetTopologySuiteTypeMappingSourcePlugin(
        ...
        public virtual RelationalTypeMapping FindMapping(in RelationalTypeMappingInfo mappingInfo)
        {
            ...
            if (storeTypeName != null)
            {
                ...
                //            typeof(XGGeometryTypeMapping<>).MakeGenericType(clrType),
                //            _geometryServices,
                //            storeTypeName,
                //            _options);
                //}
