...
//            var xgParameters = (XGParameters)parameter;
//            xgParameters.m_DbType = XGDbType.Geometry;
//        }
...
//            {
//                throw new InvalidOperationException($@"An empty spatial geometry value has been used for a type of ""{geometry.GetType()}"". The only empty value currently supported by XG is ""GeometryCollection.Empty"".");
//            }
