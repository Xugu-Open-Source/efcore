...
//using EntityFrameworkCore.XuGu.Storage.ValueConversion.Internal;
//using XuguClient;
...
//        {
//            // We are skipping the whole "ST_GeomFromText()" call here, because XG 8 switches the (lon, lat)
...
//            var XGParameter = (XGParameter)parameter;
//            XGParameter.XGDbType = XGDbType.Geometry;
//        }

//        protected virtual bool CheckEmptyValue(Geometry geometry)
//        {
//            // Only `GeometryCollection.Empty` is currently supported by XG and MariaDB.
...
//            {
//                throw new InvalidOperationException($@"An empty spatial geometry value has been used for a type of ""{geometry.GetType()}"". The only empty value currently supported by XG and MariaDB is ""GeometryCollection.Empty"".");
//            }
