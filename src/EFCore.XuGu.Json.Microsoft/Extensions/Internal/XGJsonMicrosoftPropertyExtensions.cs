...
using EntityFrameworkCore.XuGu.Json.Microsoft.Storage.ValueComparison.Internal;
using EntityFrameworkCore.XuGu.Storage.Internal;
using EntityFrameworkCore.XuGu.Storage.ValueComparison.Internal;

namespace EntityFrameworkCore.XuGu.Json.Microsoft.Extensions.Internal
{
    /// <summary>
    ...
    /// </summary>
    public static class XGInternalJsonMicrosoftPropertyExtensions
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
