...
{
    /// <summary>
    /// Provides methods for supporting translation to XG JSON operators and functions.
    /// </summary>
    public static class XGJsonDbFunctionsExtensions
    {
        ...
        /// <remarks> For possible return values see: https://dev.XG.com/doc/refman/8.0/en/json-attribute-functions.html#function_json-type </remarks>
