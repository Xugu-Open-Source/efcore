...
{
    /// <summary>
    ///     XG specific extension methods for <see cref="PropertyBuilder" />.
    /// </summary>
    public static class XGPropertyBuilderExtensions
    {
        /// <summary>
        ///     Configures the key property to use the XG IDENTITY feature to generate values for new entities,
        ...
        /// <summary>
        ///     Configures the key property to use the XG Computed feature to generate values for new entities,
        ///     when targeting XG. This method sets the property to be <see cref="ValueGenerated.OnAddOrUpdate" />.
        /// </summary>
        /// <param name="propertyBuilder"> The builder for the property being configured. </param>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        ...
        /// <summary>
        /// Returns a value indicating whether the XG character set can be set on the column associated with this property.
        /// </summary>
        /// <param name="propertyBuilder"> The builder for the property being configured. </param>
