...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class XGServiceCollectionExtensions
    {
        ...
        ///         and configures it to connect to a XG compatible database.
        ///     </para>
        ///     <para>
        ...
        ///         or by directly instantiating an object from the <see cref="XGServerVersion"/> (for XG) classes.
        ///      </para>
        /// </param>
            ...
            where TContext : DbContext
        {
            ...
            {
                optionsAction?.Invoke(options);
                options.UseXG(connectionString, xgOptionsAction);
            });
        }
