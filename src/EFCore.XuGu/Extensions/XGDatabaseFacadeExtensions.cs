...
{
    /// <summary>
    ///     XG specific extension methods for <see cref="DbContext.Database" />.
    /// </summary>
    public static class XGDatabaseFacadeExtensions
    {
        /// <summary>
        ///     <para>
        ///         Returns true if the database provider currently in use is the XG provider.
        ///     </para>
        ///     <para>
        ...
        /// <returns> True if XG is being used; false otherwise. </returns>
