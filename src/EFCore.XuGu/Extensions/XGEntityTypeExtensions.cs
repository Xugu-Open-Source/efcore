...
{
    /// <summary>
    ///     XG specific extension methods for entity types.
    /// </summary>
    public static class XGEntityTypeExtensions
    {
        ...
        /// <summary>
        /// Get the XG character set for the table associated with this entity.
        /// </summary>
        ...
        /// <summary>
        /// Sets the XG character set on the table associated with this entity. When you only specify the character set, XG implicitly
        ...
        /// <summary>
        /// Get the XG collation for the table associated with this entity.
        /// </summary>
        /// <param name="entityType"> The entity type. </param>
        ...
        /// <summary>
        /// Sets the XG collation on the table associated with this entity. When you specify the collation, XG implicitly sets the
        ...
        /// <summary>
        /// Gets the XG table options for the table associated with this entity.
        /// </summary>
        /// <param name="entityType"> The entity type. </param>
        ...
        /// <summary>
        /// Sets the XG table options for the table associated with this entity.
        /// </summary>
        /// <param name="entityType"> The entity type. </param>
