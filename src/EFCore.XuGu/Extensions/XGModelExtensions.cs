...
namespace Microsoft.EntityFrameworkCore
{
    public static class XGModelExtensions
    {
        ...
        public static XGValueGenerationStrategy? GetValueGenerationStrategy([NotNull] this IModel model)
            => (XGValueGenerationStrategy?)model[XGAnnotationNames.ValueGenerationStrategy];
