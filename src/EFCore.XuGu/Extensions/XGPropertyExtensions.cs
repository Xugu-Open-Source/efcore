...
{
    /// <summary>
    ///     Extension methods for <see cref="IProperty" /> for XG-specific metadata.
    /// </summary>
    public static class XGPropertyExtensions
    {
        ...
        public static XGValueGenerationStrategy? GetValueGenerationStrategy([NotNull] this IProperty property, StoreObjectIdentifier storeObject = default)
        {
            var annotation = property[XGAnnotationNames.ValueGenerationStrategy];
            if (annotation != null)
            {
                // Allow users to use the underlying type value instead of the enum itself.
                // Workaround for: https://github.com/PomeloFoundation/EntityFrameworkCore.XuGu/issues/1205
                //return ObjectToEnumConverter.GetEnumValue<XGValueGenerationStrategy>(annotation);
                return ObjectToEnumConverter.GetEnumValue<XGValueGenerationStrategy>(annotation);
            }
        ...
        public static void SetValueGenerationStrategy(
            [NotNull] this IMutableProperty property, XGValueGenerationStrategy? value)
        {
            CheckValueGenerationStrategy(property, value);

            property.SetOrRemoveAnnotation(XGAnnotationNames.ValueGenerationStrategy, value);
        }

        private static void CheckValueGenerationStrategy(IProperty property, XGValueGenerationStrategy? value)
        {
            if (value != null)
            {
        ...
        /// <param name="property">The property of which to get the columns charset from.</param>
        /// <returns>The name of the charset or null, if no explicit charset was set.</returns>
        internal static string GetXGLegacyCharSet([NotNull] this IProperty property)
        {
...
#pragma warning disable 618
        internal static string GetXGLegacyCollation([NotNull] this IProperty property)
