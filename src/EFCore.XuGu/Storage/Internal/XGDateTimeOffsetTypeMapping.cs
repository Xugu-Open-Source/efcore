...
namespace Microsoft.EntityFrameworkCore.XuGu.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class XGDateTimeOffsetTypeMapping : RelationalTypeMapping
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected XGDateTimeOffsetTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new XGDateTimeOffsetTypeMapping(parameters);
        ...
        protected override void ConfigureParameter(DbParameter parameter)
        {
            ...
            if (parameter.Value is DateTimeOffset dateTimeOffset)
            {
                ...
                parameter.Value = dateTimeOffset.ToString("yyyy-MM-dd HH:mm:ss.fff zzz");
            }
        }
    }
}
