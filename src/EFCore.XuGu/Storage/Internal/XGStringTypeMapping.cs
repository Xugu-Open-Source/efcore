...
namespace EntityFrameworkCore.XuGu.Storage.Internal
{
    ...
    /// </summary>
    public class XGStringTypeMapping : XGTypeMapping
    {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new XGStringTypeMapping(parameters, XGDbType, _options, IsUnquoted, _forceToString);

        public virtual RelationalTypeMapping Clone(bool? unquoted = null, bool? forceToString = null)
            => new XGStringTypeMapping(Parameters, XGDbType, _options, unquoted ?? IsUnquoted, forceToString ?? _forceToString);
        ...
        public static string EscapeSqlLiteralWithLineBreaks(string value, IXGOptions options)
        {
        ...
        public static string EscapeSqlLiteral(string literal, IXGOptions options)
            => EscapeBackslashes(Check.NotNull(literal, nameof(literal)).Replace("'", "''"), options);

        public static string EscapeBackslashes(string literal, IXGOptions options)
        {
