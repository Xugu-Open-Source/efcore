...
namespace Microsoft.EntityFrameworkCore.XuGu.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class XGDateTypeMapping : RelationalTypeMapping
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGDateTypeMapping([NotNull] string storeType)
            : this(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected XGDateTypeMapping(RelationalTypeMappingParameters parameters)
            : base(parameters)
        {
        }
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new XGDateTypeMapping(parameters);
