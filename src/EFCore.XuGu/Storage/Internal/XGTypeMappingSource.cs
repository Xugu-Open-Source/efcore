...
namespace EntityFrameworkCore.XuGu.Storage.Internal
{
    ...
    public class XGTypeMappingSource : RelationalTypeMappingSource
    {
        ...
        private void Initialize()
        {
            ...
            _tinytextUnicode = new XGStringTypeMapping("tinytext", _options, StoreTypePostfix.None);
            _textUnicode = new XGStringTypeMapping("text", _options, StoreTypePostfix.None);
            _mediumtextUnicode = new XGStringTypeMapping("mediumtext", _options, StoreTypePostfix.None);
            _longtextUnicode = new XGStringTypeMapping("clob", _options, StoreTypePostfix.None);

            _nchar = new XGStringTypeMapping("nchar", _options, StoreTypePostfix.Size, fixedLength: true);
            _nvarchar = new XGStringTypeMapping("varchar", _options, StoreTypePostfix.Size);

            _enum = new XGStringTypeMapping("enum", _options, StoreTypePostfix.None);

            _guid = new GuidTypeMapping("guid",DbType.Guid);

            _jsonDefaultString = new XGJsonTypeMapping<string>("json", null, null, _options);
            ...
            _storeTypeMappings
                = new Dictionary<string, RelationalTypeMapping[]>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    { "decimal unsigned",          new[] { _decimal } }, // deprecated since 8.0.17-XG
                    { "numeric",                   new[] { _decimal } },
                    { "numeric unsigned",          new[] { _decimal } }, // deprecated since 8.0.17-XG
                    { "dec",                       new[] { _decimal } },
                    { "dec unsigned",              new[] { _decimal } }, // deprecated since 8.0.17-XG
                    { "fixed",                     new[] { _decimal } },
                    { "fixed unsigned",            new[] { _decimal } }, // deprecated since 8.0.17-XG
                    { "double",                    new[] { _double } },
                    { "double unsigned",           new[] { _double } }, // deprecated since 8.0.17-XG
                    { "double precision",          new[] { _double } },
                    { "double precision unsigned", new[] { _double } }, // deprecated since 8.0.17-XG
                    { "real",                      new[] { _double } },
                    { "real unsigned",             new[] { _double } }, // deprecated since 8.0.17-XG
                    { "float",                     new[] { _float } },
                    { "float unsigned",            new[] { _float } }, // deprecated since 8.0.17-XG
            ...
            _clrTypeMappings
                = new Dictionary<Type, RelationalTypeMapping>
                {
                    ...
                    { typeof(DateTime), _options.DefaultDataTypeMappings.ClrDateTime switch
                        {
                            XGDateTimeType.DateTime6 =>_dateTime.Clone(6, null),
                            XGDateTimeType.Timestamp6 => _timeStamp.Clone(6, null),
                            XGDateTimeType.Timestamp => _timeStamp,
                            _ => _dateTime,
                        }},
                    { typeof(DateTimeOffset), _options.DefaultDataTypeMappings.ClrDateTimeOffset switch
                        {
                            XGDateTimeType.DateTime6 =>_dateTimeOffset.Clone(6, null),
                            XGDateTimeType.Timestamp6 => _timeStampOffset.Clone(6, null),
                    ...
                    var size = mappingInfo.Size ??
                               (mappingInfo.IsKeyOrIndex &&
                                _options.LimitKeyedOrIndexedStringColumnLength
                                   ...
                                   : (int?)null);
                    if (!string.IsNullOrEmpty(storeTypeName)&& storeTypeName.ToLower()=="clob")
                    {
                        size= null;
                    }
