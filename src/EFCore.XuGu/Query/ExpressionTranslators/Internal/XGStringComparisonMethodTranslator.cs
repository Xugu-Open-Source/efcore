...
{
    public class XGStringComparisonMethodTranslator : IMethodCallTranslator
    {
        ...
        public XGStringComparisonMethodTranslator(ISqlExpressionFactory sqlExpressionFactory, IXGOptions options)
        {
            ...
            bool startsWith)
        {
            ...
            if (prefixSuffix is SqlConstantExpression constantPrefixSuffixExpression)
            {
                ...
                // https://github.com/PomeloFoundation/EntityFrameworkCore.XuGu/issues/996#issuecomment-607876040
            ...
            // See https://github.com/PomeloFoundation/EntityFrameworkCore.XuGu/issues/996#issuecomment-607733553
