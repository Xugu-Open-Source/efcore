...
namespace Microsoft.EntityFrameworkCore.XuGu.Query.ExpressionTranslators.Internal
{
    ...
    public class XGCompositeMemberTranslator : RelationalCompositeMemberTranslator
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGCompositeMemberTranslator([NotNull] RelationalCompositeMemberTranslatorDependencies dependencies)
            : base(dependencies)
        {
            var xgTranslators = new List<IMemberTranslator>
            {
                ...
                new XGDateTimeDateComponentTranslator(),
                new XGDateTimeDatePartComponentTranslator()
            };
