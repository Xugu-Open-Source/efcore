...
/// <summary>
///     An expression that represents a XG JSON_TABLE() function call in a SQL tree.
/// </summary>
public class XGJsonTableExpression : TableValuedFunctionExpression, IClonableTableExpressionBase
{
    /// <summary>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual XGJsonTableExpression Update(
        SqlExpression jsonExpression,
        ...
        && (ReferenceEquals(columnInfos, ColumnInfos) || columnInfos is not null && ColumnInfos is not null && columnInfos.SequenceEqual(ColumnInfos))
            ? this
            : new XGJsonTableExpression(Alias, jsonExpression, path, columnInfos);
    ...
    {
        var clone = new XGJsonTableExpression(Alias, JsonExpression, Path, ColumnInfos);
    ...
    public override bool Equals(object obj)
        => ReferenceEquals(this, obj) || (obj is XGJsonTableExpression jsonTableExpression && Equals(jsonTableExpression));

    private bool Equals(XGJsonTableExpression other)
    {
