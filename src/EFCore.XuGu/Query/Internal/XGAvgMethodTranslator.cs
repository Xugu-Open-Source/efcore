...
/// </summary>
public class XGAvgMethodTranslator : IAggregateMethodCallTranslator
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public XGAvgMethodTranslator(ISqlExpressionFactory sqlExpressionFactory)
    {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        if (method.DeclaringType == typeof(Queryable)
            ...
            && (QueryableMethods.IsAverageWithoutSelector(method)
                || QueryableMethods.IsAverageWithSelector(method)))
        {
            ...
            bool isInt32 = method.ReturnType.Name.ToLower() == "Int32".ToLower();//sqlExpression.Type.Name.ToLower()=="Int32".ToLower();
            return _sqlExpressionFactory.ApplyDefaultTypeMapping(
                ...
                isInt32?typeof(long):method.ReturnType/*,//sqlExpression.Type,
