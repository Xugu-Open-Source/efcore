...
namespace Microsoft.EntityFrameworkCore.XuGu.Query.Internal
{
    public class XGParametersBasedSqlProcessor : RelationalParameterBasedSqlProcessor
    {
            ...
            out bool canCache)
        {
            ...
            queryExpression = new XGHavingExpressionVisitor((XGSqlExpressionFactory)Dependencies.SqlExpressionFactory).Visit(queryExpression);
            ...
            out bool canCache)
        {
            ...
            queryExpression = new XGSqlNullabilityProcessor(Dependencies, UseRelationalNulls)
