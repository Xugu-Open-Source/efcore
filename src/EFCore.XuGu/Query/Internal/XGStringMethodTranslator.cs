...
{
    public class XGStringMethodTranslator : IMethodCallTranslator
    {
            ...
            IDiagnosticsLogger<DbLoggerCategory.Query> logger)
        {
            ...
            {
                return new XGStringComparisonMethodTranslator(_sqlExpressionFactory, _options)
            ...
            if (_replaceMethodInfo.Equals(method))
            {
                ...
                // Due to a bug in all versions of MariaDB and all XG versions below 8.0.x (exact version that fixed the issue is
