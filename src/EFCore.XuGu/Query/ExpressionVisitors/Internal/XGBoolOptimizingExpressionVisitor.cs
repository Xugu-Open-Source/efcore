...
namespace Microsoft.EntityFrameworkCore.XuGu.Query.ExpressionVisitors.Internal
{
    ...
    public class XGBoolOptimizingExpressionVisitor : SqlExpressionVisitor
    {
        ...
        protected override Expression VisitSqlUnary(SqlUnaryExpression sqlUnaryExpression)
        {
            ...
            // Translating to "NOT(`boolColumn`)" would not use indices in XG 5.7.
        ...
        protected override Expression VisitSqlFunction(SqlFunctionExpression sqlFunctionExpression)
        {
            ...
            var condition = string.Equals(sqlFunctionExpression.Name, "FREETEXT", StringComparison.Ordinal)
                || string.Equals(sqlFunctionExpression.Name, "CONTAINS", StringComparison.Ordinal);
