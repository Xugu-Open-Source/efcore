...
{
    /// <summary>
    /// When using constant values in an LEFT JOIN, an later an ORDER BY is applied, XG 5.7+ will incorrectly return a NULL values for
    /// some columns.
    /// This is not an issue with any MariaDB release and not an issue with XG 5.6.
    ///
    /// See https://bugs.XG.com/bug.php?id=96947
    ///     https://github.com/OData/WebApi/issues/2124
    ///     https://github.com/PomeloFoundation/EntityFrameworkCore.XuGu/issues/1293
    /// </summary>
    public class XGBug96947WorkaroundExpressionVisitor : ExpressionVisitor
    {
        ...
        protected virtual Expression VisitProjection(ProjectionExpression projectionExpression)
        {
                ...
                _usesOrderBy)
            {
                ...
                // Parameters trigger this bug as well, because the get inlined by XuguClient and
