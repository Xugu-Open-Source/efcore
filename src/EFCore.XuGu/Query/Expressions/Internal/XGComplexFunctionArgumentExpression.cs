...
{
    public class XGComplexFunctionArgumentExpression : Expression
    {
        ...
        protected override Expression Accept(ExpressionVisitor visitor)
        {
            ...
            return visitor is IXGExpressionVisitor specificVisitor
                ? specificVisitor.VisitXGComplexFunctionArgumentExpression(this)
                : base.Accept(visitor);
        }
        ...
        protected override Expression VisitChildren(ExpressionVisitor visitor)
        {
            ...
            return newArgumentParts != _argumentParts
                ? new XGComplexFunctionArgumentExpression(newArgumentParts, Type)
                : this;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((XGComplexFunctionArgumentExpression)obj);
        }
