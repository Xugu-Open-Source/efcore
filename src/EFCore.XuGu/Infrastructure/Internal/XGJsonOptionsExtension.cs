...
namespace EntityFrameworkCore.XuGu.Infrastructure.Internal
{
        ...
        : IDbContextOptionsExtension
    {
        ...
        /// </summary>
        public XGJsonOptionsExtension WithJsonChangeTrackingOptions(XGCommonJsonChangeTrackingOptions options)
        ...
        public XGJsonOptionsExtension WithJsonChangeTrackingOptions(XGJsonChangeTrackingOptions options)
        {
            var clone = Clone();
