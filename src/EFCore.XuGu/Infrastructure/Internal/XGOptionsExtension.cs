...
namespace EntityFrameworkCore.XuGu.Infrastructure.Internal
{
    public class XGOptionsExtension : RelationalOptionsExtension
    {
        ...
        public XGDefaultDataTypeMappings DefaultDataTypeMappings { get; private set; }

        public XGSchemaBehavior SchemaBehavior { get; private set; }
        public XGSchemaNameTranslator SchemaNameTranslator { get; private set; }
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithServerVersion(ServerVersion serverVersion)
        {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithDisabledBackslashEscaping()
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithSettingSqlModeOnOpen()
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        public XGOptionsExtension WithDisabledLineBreakToCharSubstition()
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        public XGOptionsExtension WithDefaultDataTypeMappings(XGDefaultDataTypeMappings defaultDataTypeMappings)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        public XGOptionsExtension WithSchemaBehavior(XGSchemaBehavior behavior, XGSchemaNameTranslator translator = null)
        {
        ...
        public XGOptionsExtension WithIndexOptimizedBooleanColumns(bool enable)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        public XGOptionsExtension WithKeyedOrIndexedStringColumnLengthLimit(bool enable)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        public XGOptionsExtension WithStringComparisonTranslations(bool enable)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        private sealed class ExtensionInfo : RelationalExtensionInfo
        {
            ...
            {
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(Extension.ServerVersion)] = HashCode.Combine(Extension.ServerVersion).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.DisableBackslashEscaping)] = HashCode.Combine(Extension.NoBackslashEscapes).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.SetSqlModeOnOpen)] = HashCode.Combine(Extension.UpdateSqlModeOnOpen).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.DisableLineBreakToCharSubstition)] = HashCode.Combine(Extension.ReplaceLineBreaksWithCharFunction).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.DefaultDataTypeMappings)] = HashCode.Combine(Extension.DefaultDataTypeMappings).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.SchemaBehavior)] = HashCode.Combine(Extension.SchemaBehavior).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(Extension.SchemaNameTranslator)] = HashCode.Combine(Extension.SchemaNameTranslator).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.EnableIndexOptimizedBooleanColumns)] = HashCode.Combine(Extension.IndexOptimizedBooleanColumns).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.LimitKeyedOrIndexedStringColumnLength)] = HashCode.Combine(Extension.LimitKeyedOrIndexedStringColumnLength).ToString(CultureInfo.InvariantCulture);
                debugInfo["EntityFrameworkCore.XuGu:" + nameof(XGDbContextOptionsBuilder.EnableStringComparisonTranslations)] = HashCode.Combine(Extension.StringComparisonTranslations).ToString(CultureInfo.InvariantCulture);
            }
        }
    }
}
