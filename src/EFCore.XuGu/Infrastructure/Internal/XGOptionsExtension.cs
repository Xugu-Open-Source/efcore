...
{
    public sealed class XGOptionsExtension : RelationalOptionsExtension
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithCharSetBehavior(CharSetBehavior charSetBehavior)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithAnsiCharSetInfo(CharSetInfo charSetInfo)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension WithUnicodeCharSetInfo(CharSetInfo charSetInfo)
        {
            var clone = (XGOptionsExtension)Clone();
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public XGOptionsExtension DisableBackslashEscaping()
        {
            var clone = (XGOptionsExtension)Clone();
