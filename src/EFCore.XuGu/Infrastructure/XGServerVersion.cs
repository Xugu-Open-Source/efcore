...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public class XGServerVersion : ServerVersion
    {
        ...
        public static readonly ServerVersion LatestSupportedServerVersion = new XGServerVersion(new Version(8, 0, 31));
            ...
            : base(serverVersion.Version, serverVersion.Type, serverVersion.TypeIdentifier)
        {
            if (Type != ServerType.XG ||
                !string.Equals(TypeIdentifier, XGTypeIdentifier, StringComparison.Ordinal))
            {
        ...
        public class XGServerVersionSupport : ServerVersionSupport
        {
            ...
            public override bool JsonTableImplementationUsingParameterAsSourceWithoutEngineCrash => false; // XG non-deterministically crashes when using a parameter with JSON as the source of a JSON_TABLE call.
        }
    }
}
