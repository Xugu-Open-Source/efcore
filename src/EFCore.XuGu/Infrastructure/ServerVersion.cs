...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public abstract class ServerVersion
    {
        ...
        /// <returns>The <see cref="ServerVersion"/>.</returns>
        /// <remarks>
        /// The general format is `major.minor.patch-type`, e.g. `8.0.21-mysql`. If the type is being omitted, it is
        /// assumed to be XG.
        /// </remarks>
        ...
        /// <remarks>
        /// The general format is `major.minor.patch-type`, e.g. `8.0.21-mysql`. If the type is being omitted, it is
        /// assumed to be XG. The <paramref name="serverType"/> parameter takes precedence over a server type specified
        ...
        public static bool TryParse(string versionString, ServerType? serverType, out ServerVersion serverVersion)
        {
            ...
            if (semanticVersion.Count > 0)
            {
                ...
                var version = semanticVersion.Count > 1
