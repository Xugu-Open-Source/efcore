...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    public class XGDbContextOptionsBuilder : RelationalDbContextOptionsBuilder<XGDbContextOptionsBuilder, XGOptionsExtension>
    {
        ...
        /// <summary>
        ///     Configures default mappings between specific CLR and XG types.
        /// </summary>
        ...
        ///     XG does not support the EF Core concept of schemas, the default is to throw an
        ///     exception.
        /// </summary>
        ...
        ///     to their SQL equivalent, even though XG might not be able to use indexes when executing the query, resulting in decreased
        ///     performance. Whether XG is able to use indexes for the query, depends on the <see cref="StringComparison"/> option, the
        ...
        /// <summary>
        ///     Configures the context to translate using primitive collections. At the time of the Pomelo 8.0.0 release, XG Server can
        ///     crash when using primitive collections with JSON support is incomplete. Support and translations in regards to
