...
namespace Microsoft.EntityFrameworkCore.XuGu.Metadata.Conventions.Internal
{
    /// <summary>
    ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
    ///     directly from your code. This API may change or be removed in future releases.
    /// </summary>
    public class XGValueGeneratorConvention : RelationalValueGeneratorConvention
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        ...
        public override ValueGenerated? GetValueGenerated(Property property)
        {
            ...
            var valueGenerationStrategy = property.XG().GetXGValueGenerationStrategy(fallbackToModel: false);
            if (valueGenerationStrategy.HasValue)
            {
                switch (valueGenerationStrategy.Value)
                {
                    case XGValueGenerationStrategy.IdentityColumn:
                        return ValueGenerated.OnAdd;
                    case XGValueGenerationStrategy.ComputedColumn:
