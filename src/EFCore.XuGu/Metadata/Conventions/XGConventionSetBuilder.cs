...
using EntityFrameworkCore.XuGu.Metadata.Conventions;
...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    public class XGConventionSetBuilder : RelationalConventionSetBuilder
    {
        ...
        public override ConventionSet CreateConventionSet()
        {
            ...
            var valueGeneratorConvention = new XGValueGenerationConvention(Dependencies, RelationalDependencies);
        ...
        /// <summary>
        ///     <para>
        ///         Call this method to build a <see cref="ConventionSet" /> for XG when using
