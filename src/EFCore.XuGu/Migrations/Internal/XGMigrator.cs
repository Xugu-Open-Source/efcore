...
namespace EntityFrameworkCore.XuGu.Migrations.Internal
{
    public class XGMigrator : Migrator
    {
        ...
        private const string BeforeDropPrimaryKeyMigrationBegin = @"DROP PROCEDURE IF EXISTS `XuGu_BEFORE_DROP_PRIMARY_KEY`;
...
END;";
        ...
        private const string BeforeDropPrimaryKeyMigrationEnd = @"DROP PROCEDURE `XuGu_BEFORE_DROP_PRIMARY_KEY`;";

        private const string AfterAddPrimaryKeyMigrationBegin = @"DROP PROCEDURE IF EXISTS `XuGu_AFTER_ADD_PRIMARY_KEY`;
...
END;";
        ...
        private const string AfterAddPrimaryKeyMigrationEnd = @"DROP PROCEDURE `XuGu_AFTER_ADD_PRIMARY_KEY`;";
    }
}
