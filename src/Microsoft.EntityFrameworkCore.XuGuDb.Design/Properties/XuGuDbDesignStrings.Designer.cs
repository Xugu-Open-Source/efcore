...
namespace Microsoft.EntityFrameworkCore.Internal
{
	...
	/// </summary>
    public static class XuGuDbDesignStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Microsoft.EntityFrameworkCore.XuGuDb.Design.Properties.XuGuDbDesignStrings", typeof(XuGuDbDesignStrings).GetTypeInfo().Assembly);
        ...
        /// <summary>
        /// For column {columnId}. This column is set up as an Identity column, but the SQL Server data type is {XuGuDbDataType}. This will be mapped to CLR type byte which does not allow the XuGuDbValueGenerationStrategy.IdentityColumn setting. Generating a matching Property but ignoring the Identity setting.
        /// </summary>
        public static string DataTypeDoesNotAllowXuGuDbIdentityStrategy([CanBeNull] object columnId, [CanBeNull] object XuGuDbDataType)
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("DataTypeDoesNotAllowXuGuDbIdentityStrategy", "columnId", "XuGuDbDataType"), columnId, XuGuDbDataType);
        }
